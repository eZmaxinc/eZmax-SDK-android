...
```java
// Import classes:
//import org.openapitools.client.api.ObjectAgenttypeApi;

ObjectAgenttypeApi apiInstance = new ObjectAgenttypeApi();
String sSelector = null; // String | The type of Agenttypes to return
...
------------- | ------------- | ------------- | -------------
 **sSelector** | **String**| The type of Agenttypes to return | [default to null] [enum: All]
