...
```java
// Import classes:
//import org.openapitools.client.api.ObjectOtherincometypeApi;

ObjectOtherincometypeApi apiInstance = new ObjectOtherincometypeApi();
String sSelector = null; // String | The type of Otherincometypes to return
...
------------- | ------------- | ------------- | -------------
 **sSelector** | **String**| The type of Otherincometypes to return | [default to null] [enum: All]
