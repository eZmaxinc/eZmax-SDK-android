...
```java
// Import classes:
//import org.openapitools.client.api.ObjectBrokertypeApi;

ObjectBrokertypeApi apiInstance = new ObjectBrokertypeApi();
String sSelector = null; // String | The type of Brokertypes to return
...
------------- | ------------- | ------------- | -------------
 **sSelector** | **String**| The type of Brokertypes to return | [default to null] [enum: All]
