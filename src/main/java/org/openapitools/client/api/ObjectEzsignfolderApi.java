...
import org.openapitools.client.model.EzsignfolderDuplicateV1Request;
import org.openapitools.client.model.EzsignfolderDuplicateV1Response;
...
import org.openapitools.client.model.EzsignfolderGetActionableElementsForSignerV1Response;
import org.openapitools.client.model.EzsignfolderGetActionableElementsV1Response;
import org.openapitools.client.model.EzsignfolderGetActionableElementsV2Response;
import org.openapitools.client.model.EzsignfolderGetActionableElementsV3Response;
...
import org.openapitools.client.model.EzsignfolderGetCommunicationrecipientsV1Response;
import org.openapitools.client.model.EzsignfolderGetCommunicationsendersV1Response;
import org.openapitools.client.model.EzsignfolderGetEzsignannotationsV1Response;
import org.openapitools.client.model.EzsignfolderGetEzsigndocumentsV1Response;
import org.openapitools.client.model.EzsignfolderGetEzsigndocumentsV2Response;
import org.openapitools.client.model.EzsignfolderGetEzsignfoldersignerassociationsV1Response;
import org.openapitools.client.model.EzsignfolderGetEzsignfoldersignerassociationsV2Response;
import org.openapitools.client.model.EzsignfolderGetEzsignformfieldgroupsV1Response;
import org.openapitools.client.model.EzsignfolderGetEzsignsignaturesAutomaticV1Response;
import org.openapitools.client.model.EzsignfolderGetEzsignsignaturesV1Response;
...
import org.openapitools.client.model.EzsignfolderGetObjectV3Response;
...
import org.openapitools.client.model.EzsignfolderImportEzsigntemplatepackageV2Request;
import org.openapitools.client.model.EzsignfolderImportEzsigntemplatepackageV2Response;
import org.openapitools.client.model.EzsignfolderImportEzsigntemplatepackageV3Request;
import org.openapitools.client.model.EzsignfolderImportEzsigntemplatepackageV3Response;
...
public class ObjectEzsignfolderApi {
  ...
  */
  public EzsignfolderCreateObjectV3Response ezsignfolderCreateObjectV3 (EzsignfolderCreateObjectV3Request ezsignfolderCreateObjectV3Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (ezsignfolderCreateObjectV3Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfolderCreateObjectV3Request' when calling ezsignfolderCreateObjectV3",
        new ApiException(400, "Missing the required parameter 'ezsignfolderCreateObjectV3Request' when calling ezsignfolderCreateObjectV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsignfolder";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderCreateObjectV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderCreateObjectV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param ezsignfolderCreateObjectV3Request 
  */
  public void ezsignfolderCreateObjectV3 (EzsignfolderCreateObjectV3Request ezsignfolderCreateObjectV3Request, final Response.Listener<EzsignfolderCreateObjectV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsignfolderCreateObjectV3Request;
    ...
    // create path and map variables
    String path = "/3/object/ezsignfolder".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderCreateObjectV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderCreateObjectV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderDuplicateV1Response ezsignfolderDuplicateV1 (Integer pkiEzsignfolderID, EzsignfolderDuplicateV1Request ezsignfolderDuplicateV1Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ezsignfolderDuplicateV1Request;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderDuplicateV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderDuplicateV1"));
    }
    // verify the required parameter 'ezsignfolderDuplicateV1Request' is set
    if (ezsignfolderDuplicateV1Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfolderDuplicateV1Request' when calling ezsignfolderDuplicateV1",
        new ApiException(400, "Missing the required parameter 'ezsignfolderDuplicateV1Request' when calling ezsignfolderDuplicateV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/duplicate".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderDuplicateV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderDuplicateV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Duplicate the Ezsignfolder
   * 
   * @param pkiEzsignfolderID    * @param ezsignfolderDuplicateV1Request 
  */
  public void ezsignfolderDuplicateV1 (Integer pkiEzsignfolderID, EzsignfolderDuplicateV1Request ezsignfolderDuplicateV1Request, final Response.Listener<EzsignfolderDuplicateV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsignfolderDuplicateV1Request;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/duplicate".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderDuplicateV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderDuplicateV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderEditObjectV3Response ezsignfolderEditObjectV3 (Integer pkiEzsignfolderID, EzsignfolderEditObjectV3Request ezsignfolderEditObjectV3Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderEditObjectV3",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderEditObjectV3"));
    }
    // verify the required parameter 'ezsignfolderEditObjectV3Request' is set
    if (ezsignfolderEditObjectV3Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfolderEditObjectV3Request' when calling ezsignfolderEditObjectV3",
        new ApiException(400, "Missing the required parameter 'ezsignfolderEditObjectV3Request' when calling ezsignfolderEditObjectV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsignfolder/{pkiEzsignfolderID}".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
  ...
  */
  public void ezsignfolderEditObjectV3 (Integer pkiEzsignfolderID, EzsignfolderEditObjectV3Request ezsignfolderEditObjectV3Request, final Response.Listener<EzsignfolderEditObjectV3Response> responseListener, final Response.ErrorListener errorListener) {
    ...
    // create path and map variables
    String path = "/3/object/ezsignfolder/{pkiEzsignfolderID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
  ...
  */
  public EzsignfolderEndPrematurelyV1Response ezsignfolderEndPrematurelyV1 (Integer pkiEzsignfolderID, Object body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderEndPrematurelyV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderEndPrematurelyV1"));
    }
    // verify the required parameter 'body' is set
    if (body == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'body' when calling ezsignfolderEndPrematurelyV1",
        new ApiException(400, "Missing the required parameter 'body' when calling ezsignfolderEndPrematurelyV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/endPrematurely".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
  ...
  */
  public void ezsignfolderEndPrematurelyV1 (Integer pkiEzsignfolderID, Object body, final Response.Listener<EzsignfolderEndPrematurelyV1Response> responseListener, final Response.ErrorListener errorListener) {
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/endPrematurely".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
  ...
  */
  public EzsignfolderGetActionableElementsForSignerV1Response ezsignfolderGetActionableElementsForSignerV1 (Integer pkiEzsignfolderID, String eSignerType, Integer fkiEzsignsignerID, Integer fkiUserID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetActionableElementsForSignerV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetActionableElementsForSignerV1"));
    }
    // verify the required parameter 'eSignerType' is set
    if (eSignerType == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'eSignerType' when calling ezsignfolderGetActionableElementsForSignerV1",
        new ApiException(400, "Missing the required parameter 'eSignerType' when calling ezsignfolderGetActionableElementsForSignerV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElementsForSigner".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (EzsignfolderGetActionableElementsForSignerV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetActionableElementsForSignerV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Retrieve actionable elements of a user for the Ezsignfolder
   * Return the Ezsignsignatures that can be signed and Ezsignformfieldgroups that can be filled by an user at the current step in the process
   * @param pkiEzsignfolderID    * @param eSignerType    * @param fkiEzsignsignerID    * @param fkiUserID 
  */
  public void ezsignfolderGetActionableElementsForSignerV1 (Integer pkiEzsignfolderID, String eSignerType, Integer fkiEzsignsignerID, Integer fkiUserID, final Response.Listener<EzsignfolderGetActionableElementsForSignerV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElementsForSigner".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetActionableElementsForSignerV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetActionableElementsForSignerV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetActionableElementsV2Response ezsignfolderGetActionableElementsV2 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetActionableElementsV2",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetActionableElementsV2"));
    }

    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetActionableElementsV2Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetActionableElementsV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetActionableElementsV2 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetActionableElementsV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetActionableElementsV2Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetActionableElementsV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetActionableElementsV3Response ezsignfolderGetActionableElementsV3 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetActionableElementsV3",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetActionableElementsV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetActionableElementsV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetActionableElementsV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetActionableElementsV3 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetActionableElementsV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/3/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetActionableElementsV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetActionableElementsV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetAttachmentCountV1Response ezsignfolderGetAttachmentCountV1 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetAttachmentCountV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetAttachmentCountV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getAttachmentCount".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetAttachmentCountV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetAttachmentCountV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetAttachmentCountV1 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetAttachmentCountV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getAttachmentCount".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetAttachmentCountV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetAttachmentCountV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetAttachmentsV1Response ezsignfolderGetAttachmentsV1 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetAttachmentsV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetAttachmentsV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getAttachments".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetAttachmentsV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetAttachmentsV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetAttachmentsV1 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetAttachmentsV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getAttachments".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetAttachmentsV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetAttachmentsV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetCommunicationrecipientsV1Response ezsignfolderGetCommunicationrecipientsV1 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetCommunicationrecipientsV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetCommunicationrecipientsV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationrecipients".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetCommunicationrecipientsV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetCommunicationrecipientsV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetCommunicationrecipientsV1 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetCommunicationrecipientsV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationrecipients".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetCommunicationrecipientsV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetCommunicationrecipientsV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetCommunicationsendersV1Response ezsignfolderGetCommunicationsendersV1 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetCommunicationsendersV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetCommunicationsendersV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationsenders".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetCommunicationsendersV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetCommunicationsendersV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetCommunicationsendersV1 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetCommunicationsendersV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationsenders".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetCommunicationsendersV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetCommunicationsendersV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetEzsignannotationsV1Response ezsignfolderGetEzsignannotationsV1 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsignannotationsV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsignannotationsV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignannotations".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetEzsignannotationsV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetEzsignannotationsV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetEzsignannotationsV1 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetEzsignannotationsV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignannotations".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetEzsignannotationsV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetEzsignannotationsV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetEzsigndocumentsV2Response ezsignfolderGetEzsigndocumentsV2 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsigndocumentsV2",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsigndocumentsV2"));
    }

    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsigndocuments".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetEzsigndocumentsV2Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetEzsigndocumentsV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetEzsigndocumentsV2 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetEzsigndocumentsV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsigndocuments".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetEzsigndocumentsV2Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetEzsigndocumentsV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetEzsignfoldersignerassociationsV2Response ezsignfolderGetEzsignfoldersignerassociationsV2 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsignfoldersignerassociationsV2",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsignfoldersignerassociationsV2"));
    }

    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociations".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetEzsignfoldersignerassociationsV2Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetEzsignfoldersignerassociationsV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetEzsignfoldersignerassociationsV2 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetEzsignfoldersignerassociationsV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociations".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetEzsignfoldersignerassociationsV2Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetEzsignfoldersignerassociationsV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetEzsignformfieldgroupsV1Response ezsignfolderGetEzsignformfieldgroupsV1 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsignformfieldgroupsV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsignformfieldgroupsV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignformfieldgroups".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetEzsignformfieldgroupsV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetEzsignformfieldgroupsV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetEzsignformfieldgroupsV1 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetEzsignformfieldgroupsV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignformfieldgroups".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetEzsignformfieldgroupsV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetEzsignformfieldgroupsV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetEzsignsignaturesV1Response ezsignfolderGetEzsignsignaturesV1 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsignsignaturesV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetEzsignsignaturesV1"));
    }

    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignatures".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetEzsignsignaturesV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetEzsignsignaturesV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetEzsignsignaturesV1 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetEzsignsignaturesV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignatures".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetEzsignsignaturesV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetEzsignsignaturesV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderGetObjectV3Response ezsignfolderGetObjectV3 (Integer pkiEzsignfolderID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetObjectV3",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetObjectV3"));
    }
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderGetObjectV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderGetObjectV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfolderID 
  */
  public void ezsignfolderGetObjectV3 (Integer pkiEzsignfolderID, final Response.Listener<EzsignfolderGetObjectV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderGetObjectV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderGetObjectV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderImportEzsigntemplatepackageV2Response ezsignfolderImportEzsigntemplatepackageV2 (Integer pkiEzsignfolderID, EzsignfolderImportEzsigntemplatepackageV2Request ezsignfolderImportEzsigntemplatepackageV2Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ezsignfolderImportEzsigntemplatepackageV2Request;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderImportEzsigntemplatepackageV2",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderImportEzsigntemplatepackageV2"));
    }
    ...
    if (ezsignfolderImportEzsigntemplatepackageV2Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfolderImportEzsigntemplatepackageV2Request' when calling ezsignfolderImportEzsigntemplatepackageV2",
        new ApiException(400, "Missing the required parameter 'ezsignfolderImportEzsigntemplatepackageV2Request' when calling ezsignfolderImportEzsigntemplatepackageV2"));
    }

    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderImportEzsigntemplatepackageV2Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderImportEzsigntemplatepackageV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Import an Ezsigntemplatepackage in the Ezsignfolder
   * This endpoint imports all of the Ezsigntemplates from the Ezsigntemplatepackage into the Ezsignfolder as Ezsigndocuments.  This allows to automatically apply all the Ezsigntemplateformfieldgroups and Ezsigntemplatesignatures on the newly created Ezsigndocuments in a single step.
   * @param pkiEzsignfolderID    * @param ezsignfolderImportEzsigntemplatepackageV2Request 
  */
  public void ezsignfolderImportEzsigntemplatepackageV2 (Integer pkiEzsignfolderID, EzsignfolderImportEzsigntemplatepackageV2Request ezsignfolderImportEzsigntemplatepackageV2Request, final Response.Listener<EzsignfolderImportEzsigntemplatepackageV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsignfolderImportEzsigntemplatepackageV2Request;
    ...
    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderImportEzsigntemplatepackageV2Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderImportEzsigntemplatepackageV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderImportEzsigntemplatepackageV3Response ezsignfolderImportEzsigntemplatepackageV3 (Integer pkiEzsignfolderID, EzsignfolderImportEzsigntemplatepackageV3Request ezsignfolderImportEzsigntemplatepackageV3Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ezsignfolderImportEzsigntemplatepackageV3Request;
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderImportEzsigntemplatepackageV3",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderImportEzsigntemplatepackageV3"));
    }
    ...
    if (ezsignfolderImportEzsigntemplatepackageV3Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfolderImportEzsigntemplatepackageV3Request' when calling ezsignfolderImportEzsigntemplatepackageV3",
        new ApiException(400, "Missing the required parameter 'ezsignfolderImportEzsigntemplatepackageV3Request' when calling ezsignfolderImportEzsigntemplatepackageV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfolderImportEzsigntemplatepackageV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfolderImportEzsigntemplatepackageV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Import an Ezsigntemplatepackage in the Ezsignfolder
   * This endpoint imports all of the Ezsigntemplates from the Ezsigntemplatepackage into the Ezsignfolder as Ezsigndocuments.  This allows to automatically apply all the Ezsigntemplateformfieldgroups and Ezsigntemplatesignatures on the newly created Ezsigndocuments in a single step.
   * @param pkiEzsignfolderID    * @param ezsignfolderImportEzsigntemplatepackageV3Request 
  */
  public void ezsignfolderImportEzsigntemplatepackageV3 (Integer pkiEzsignfolderID, EzsignfolderImportEzsigntemplatepackageV3Request ezsignfolderImportEzsigntemplatepackageV3Request, final Response.Listener<EzsignfolderImportEzsigntemplatepackageV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsignfolderImportEzsigntemplatepackageV3Request;
    ...
    // create path and map variables
    String path = "/3/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfolderImportEzsigntemplatepackageV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfolderImportEzsigntemplatepackageV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfolderReorderV2Response ezsignfolderReorderV2 (Integer pkiEzsignfolderID, EzsignfolderReorderV2Request ezsignfolderReorderV2Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'pkiEzsignfolderID' is set
    if (pkiEzsignfolderID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderReorderV2",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderReorderV2"));
    }
    // verify the required parameter 'ezsignfolderReorderV2Request' is set
    if (ezsignfolderReorderV2Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfolderReorderV2Request' when calling ezsignfolderReorderV2",
        new ApiException(400, "Missing the required parameter 'ezsignfolderReorderV2Request' when calling ezsignfolderReorderV2"));
    }

    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/reorder".replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
  ...
  */
  public void ezsignfolderReorderV2 (Integer pkiEzsignfolderID, EzsignfolderReorderV2Request ezsignfolderReorderV2Request, final Response.Listener<EzsignfolderReorderV2Response> responseListener, final Response.ErrorListener errorListener) {
    ...
    // create path and map variables
    String path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/reorder".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfolderID" + "\\}", apiInvoker.escapeString(pkiEzsignfolderID.toString()));
