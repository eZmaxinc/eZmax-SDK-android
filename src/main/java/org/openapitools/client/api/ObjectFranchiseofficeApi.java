...
public class ObjectFranchiseofficeApi {
  ...
  */
  public CommonGetAutocompleteV1Response franchiseofficeGetAutocompleteV1 (String sSelector, String sQuery, HeaderAcceptLanguage acceptLanguage) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Retrieve Franchiseoffices and IDs
   * Get the list of Franchiseoffices to be used in a dropdown or autocomplete control.
   * @param sSelector The type of Franchiseoffices to return   * @param sQuery Allow to filter the returned results   * @param acceptLanguage 
  */
  public void franchiseofficeGetAutocompleteV1 (String sSelector, String sQuery, HeaderAcceptLanguage acceptLanguage, final Response.Listener<CommonGetAutocompleteV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
