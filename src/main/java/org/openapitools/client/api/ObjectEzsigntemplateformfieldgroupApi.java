...
import org.openapitools.client.model.EzsigntemplateformfieldgroupGetObjectV1Response;
...
public class ObjectEzsigntemplateformfieldgroupApi {
  ...
  */
  public EzsigntemplateformfieldgroupGetObjectV1Response ezsigntemplateformfieldgroupGetObjectV1 (Integer pkiEzsigntemplateformfieldgroupID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsigntemplateformfieldgroupID' is set
    if (pkiEzsigntemplateformfieldgroupID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsigntemplateformfieldgroupID' when calling ezsigntemplateformfieldgroupGetObjectV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsigntemplateformfieldgroupID' when calling ezsigntemplateformfieldgroupGetObjectV1"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (EzsigntemplateformfieldgroupGetObjectV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsigntemplateformfieldgroupGetObjectV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsigntemplateformfieldgroupID 
  */
  public void ezsigntemplateformfieldgroupGetObjectV1 (Integer pkiEzsigntemplateformfieldgroupID, final Response.Listener<EzsigntemplateformfieldgroupGetObjectV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsigntemplateformfieldgroupGetObjectV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsigntemplateformfieldgroupGetObjectV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
