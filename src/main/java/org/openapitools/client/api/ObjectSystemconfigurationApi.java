...
public class ObjectSystemconfigurationApi {
  ...
  */
  public SystemconfigurationGetObjectV2Response systemconfigurationGetObjectV2 (Integer pkiSystemconfigurationID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiSystemconfigurationID' is set
    if (pkiSystemconfigurationID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiSystemconfigurationID' when calling systemconfigurationGetObjectV2",
        new ApiException(400, "Missing the required parameter 'pkiSystemconfigurationID' when calling systemconfigurationGetObjectV2"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (SystemconfigurationGetObjectV2Response) ApiInvoker.deserialize(localVarResponse, "", SystemconfigurationGetObjectV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiSystemconfigurationID The unique ID of the Systemconfiguration
  */
  public void systemconfigurationGetObjectV2 (Integer pkiSystemconfigurationID, final Response.Listener<SystemconfigurationGetObjectV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((SystemconfigurationGetObjectV2Response) ApiInvoker.deserialize(localVarResponse,  "", SystemconfigurationGetObjectV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
