...
import org.openapitools.client.model.TranqcontractImportIntoEDMV1Request;
import org.openapitools.client.model.TranqcontractImportIntoEDMV1Response;
...
public class ObjectTranqcontractApi {
  ...
  */
  public TranqcontractImportIntoEDMV1Response tranqcontractImportIntoEDMV1 (Integer pkiTranqcontractID, TranqcontractImportIntoEDMV1Request tranqcontractImportIntoEDMV1Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = tranqcontractImportIntoEDMV1Request;
    // verify the required parameter 'pkiTranqcontractID' is set
    if (pkiTranqcontractID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiTranqcontractID' when calling tranqcontractImportIntoEDMV1",
        new ApiException(400, "Missing the required parameter 'pkiTranqcontractID' when calling tranqcontractImportIntoEDMV1"));
    }
    // verify the required parameter 'tranqcontractImportIntoEDMV1Request' is set
    if (tranqcontractImportIntoEDMV1Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'tranqcontractImportIntoEDMV1Request' when calling tranqcontractImportIntoEDMV1",
        new ApiException(400, "Missing the required parameter 'tranqcontractImportIntoEDMV1Request' when calling tranqcontractImportIntoEDMV1"));
    }

    // create path and map variables
    String path = "/1/object/tranqcontract/{pkiTranqcontractID}/importIntoEDM".replaceAll("\\{" + "pkiTranqcontractID" + "\\}", apiInvoker.escapeString(pkiTranqcontractID.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (TranqcontractImportIntoEDMV1Response) ApiInvoker.deserialize(localVarResponse, "", TranqcontractImportIntoEDMV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Import attachments into the Tranqcontract
   * 
   * @param pkiTranqcontractID    * @param tranqcontractImportIntoEDMV1Request 
  */
  public void tranqcontractImportIntoEDMV1 (Integer pkiTranqcontractID, TranqcontractImportIntoEDMV1Request tranqcontractImportIntoEDMV1Request, final Response.Listener<TranqcontractImportIntoEDMV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = tranqcontractImportIntoEDMV1Request;
    ...
    // create path and map variables
    String path = "/1/object/tranqcontract/{pkiTranqcontractID}/importIntoEDM".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiTranqcontractID" + "\\}", apiInvoker.escapeString(pkiTranqcontractID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((TranqcontractImportIntoEDMV1Response) ApiInvoker.deserialize(localVarResponse,  "", TranqcontractImportIntoEDMV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
