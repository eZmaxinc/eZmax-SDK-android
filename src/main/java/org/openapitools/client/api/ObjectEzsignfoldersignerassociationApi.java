...
public class ObjectEzsignfoldersignerassociationApi {
  ...
  */
   ...
   * Modify an existing Ezsignfoldersignerassociation
   * 
   * @param pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation   * @param ezsignfoldersignerassociationEditObjectV1Request 
  */
  ...
  * 
   ...
   * @return void
  */
  public void ezsignfoldersignerassociationGetObjectGetChildrenV1 (Integer pkiEzsignfoldersignerassociationID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfoldersignerassociationID' is set
    if (pkiEzsignfoldersignerassociationID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfoldersignerassociationID' when calling ezsignfoldersignerassociationGetObjectGetChildrenV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfoldersignerassociationID' when calling ezsignfoldersignerassociationGetObjectGetChildrenV1"));
    }
   ...
   * @param pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation
  */
  public void ezsignfoldersignerassociationGetObjectGetChildrenV1 (Integer pkiEzsignfoldersignerassociationID, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
