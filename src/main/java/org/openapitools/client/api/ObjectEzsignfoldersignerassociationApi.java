...
import org.openapitools.client.model.EzsignfoldersignerassociationCreateEmbeddedUrlV2Request;
import org.openapitools.client.model.EzsignfoldersignerassociationCreateEmbeddedUrlV2Response;
...
import org.openapitools.client.model.EzsignfoldersignerassociationCreateObjectV3Request;
import org.openapitools.client.model.EzsignfoldersignerassociationCreateObjectV3Response;
...
import org.openapitools.client.model.EzsignfoldersignerassociationEditObjectV2Request;
import org.openapitools.client.model.EzsignfoldersignerassociationEditObjectV2Response;
...
import org.openapitools.client.model.EzsignfoldersignerassociationGetObjectV3Response;
...
public class ObjectEzsignfoldersignerassociationApi {
  ...
  */
  public EzsignfoldersignerassociationCreateEmbeddedUrlV2Response ezsignfoldersignerassociationCreateEmbeddedUrlV2 (Integer pkiEzsignfoldersignerassociationID, EzsignfoldersignerassociationCreateEmbeddedUrlV2Request ezsignfoldersignerassociationCreateEmbeddedUrlV2Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ezsignfoldersignerassociationCreateEmbeddedUrlV2Request;
    // verify the required parameter 'pkiEzsignfoldersignerassociationID' is set
    if (pkiEzsignfoldersignerassociationID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfoldersignerassociationID' when calling ezsignfoldersignerassociationCreateEmbeddedUrlV2",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfoldersignerassociationID' when calling ezsignfoldersignerassociationCreateEmbeddedUrlV2"));
    }
    ...
    if (ezsignfoldersignerassociationCreateEmbeddedUrlV2Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfoldersignerassociationCreateEmbeddedUrlV2Request' when calling ezsignfoldersignerassociationCreateEmbeddedUrlV2",
        new ApiException(400, "Missing the required parameter 'ezsignfoldersignerassociationCreateEmbeddedUrlV2Request' when calling ezsignfoldersignerassociationCreateEmbeddedUrlV2"));
    }

    // create path and map variables
    String path = "/2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}/createEmbeddedUrl".replaceAll("\\{" + "pkiEzsignfoldersignerassociationID" + "\\}", apiInvoker.escapeString(pkiEzsignfoldersignerassociationID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfoldersignerassociationCreateEmbeddedUrlV2Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfoldersignerassociationCreateEmbeddedUrlV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Creates an Url to allow embedded signing
   * This endpoint creates an Url that can be used in a browser or embedded in an I-Frame to allow signing.  The signer Login type must be configured as Embedded.  ### Iframe Communication (postMessage)  If the signing page is embedded in an &#x60;iframe&#x60;, the application sends events to the parent window via &#x60;window.postMessage&#x60;.  The message structure is defined as follows:  &#x60;&#x60;&#x60;json {   \&quot;source\&quot;: \&quot;ezsign\&quot;,   \&quot;type\&quot;: \&quot;eEzsignEvent\&quot;,   \&quot;payload\&quot;: \&quot;CompletedEzsignfolder\&quot; } &#x60;&#x60;&#x60;  * **source**: Always &#x60;&#39;ezsign&#39;&#x60;. * **type**: Always &#x60;&#39;eEzsignEvent&#39;&#x60;. * **payload**: Corresponds to the **eEzsignEvent** values listed in the table above (e.g., &#x60;SessionTimeout&#x60;, &#x60;CompletedStep&#x60;, etc.).  #### Example listener  &#x60;&#x60;&#x60;javascript window.addEventListener(&#39;message&#39;, (event) &#x3D;&gt; {     const { source, type, payload } &#x3D; event.data;         if (source &#x3D;&#x3D;&#x3D; &#39;ezsign&#39; &amp;&amp; type &#x3D;&#x3D;&#x3D; &#39;eEzsignEvent&#39;) {         console.log(&#39;Event received:&#39;, payload);     } }); &#x60;&#x60;&#x60; 
   * @param pkiEzsignfoldersignerassociationID    * @param ezsignfoldersignerassociationCreateEmbeddedUrlV2Request 
  */
  public void ezsignfoldersignerassociationCreateEmbeddedUrlV2 (Integer pkiEzsignfoldersignerassociationID, EzsignfoldersignerassociationCreateEmbeddedUrlV2Request ezsignfoldersignerassociationCreateEmbeddedUrlV2Request, final Response.Listener<EzsignfoldersignerassociationCreateEmbeddedUrlV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsignfoldersignerassociationCreateEmbeddedUrlV2Request;
    ...
    // create path and map variables
    String path = "/2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}/createEmbeddedUrl".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfoldersignerassociationID" + "\\}", apiInvoker.escapeString(pkiEzsignfoldersignerassociationID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfoldersignerassociationCreateEmbeddedUrlV2Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfoldersignerassociationCreateEmbeddedUrlV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfoldersignerassociationCreateObjectV3Response ezsignfoldersignerassociationCreateObjectV3 (EzsignfoldersignerassociationCreateObjectV3Request ezsignfoldersignerassociationCreateObjectV3Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (ezsignfoldersignerassociationCreateObjectV3Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfoldersignerassociationCreateObjectV3Request' when calling ezsignfoldersignerassociationCreateObjectV3",
        new ApiException(400, "Missing the required parameter 'ezsignfoldersignerassociationCreateObjectV3Request' when calling ezsignfoldersignerassociationCreateObjectV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsignfoldersignerassociation";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfoldersignerassociationCreateObjectV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfoldersignerassociationCreateObjectV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param ezsignfoldersignerassociationCreateObjectV3Request 
  */
  public void ezsignfoldersignerassociationCreateObjectV3 (EzsignfoldersignerassociationCreateObjectV3Request ezsignfoldersignerassociationCreateObjectV3Request, final Response.Listener<EzsignfoldersignerassociationCreateObjectV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsignfoldersignerassociationCreateObjectV3Request;
    ...
    // create path and map variables
    String path = "/3/object/ezsignfoldersignerassociation".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfoldersignerassociationCreateObjectV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfoldersignerassociationCreateObjectV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfoldersignerassociationEditObjectV2Response ezsignfoldersignerassociationEditObjectV2 (Integer pkiEzsignfoldersignerassociationID, EzsignfoldersignerassociationEditObjectV2Request ezsignfoldersignerassociationEditObjectV2Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ezsignfoldersignerassociationEditObjectV2Request;
    // verify the required parameter 'pkiEzsignfoldersignerassociationID' is set
    if (pkiEzsignfoldersignerassociationID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfoldersignerassociationID' when calling ezsignfoldersignerassociationEditObjectV2",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfoldersignerassociationID' when calling ezsignfoldersignerassociationEditObjectV2"));
    }
    ...
    if (ezsignfoldersignerassociationEditObjectV2Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignfoldersignerassociationEditObjectV2Request' when calling ezsignfoldersignerassociationEditObjectV2",
        new ApiException(400, "Missing the required parameter 'ezsignfoldersignerassociationEditObjectV2Request' when calling ezsignfoldersignerassociationEditObjectV2"));
    }
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "PUT", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfoldersignerassociationEditObjectV2Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfoldersignerassociationEditObjectV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Edit an existing Ezsignfoldersignerassociation
   * 
   * @param pkiEzsignfoldersignerassociationID    * @param ezsignfoldersignerassociationEditObjectV2Request 
  */
  public void ezsignfoldersignerassociationEditObjectV2 (Integer pkiEzsignfoldersignerassociationID, EzsignfoldersignerassociationEditObjectV2Request ezsignfoldersignerassociationEditObjectV2Request, final Response.Listener<EzsignfoldersignerassociationEditObjectV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsignfoldersignerassociationEditObjectV2Request;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "PUT", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfoldersignerassociationEditObjectV2Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfoldersignerassociationEditObjectV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignfoldersignerassociationGetObjectV3Response ezsignfoldersignerassociationGetObjectV3 (Integer pkiEzsignfoldersignerassociationID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignfoldersignerassociationID' is set
    if (pkiEzsignfoldersignerassociationID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignfoldersignerassociationID' when calling ezsignfoldersignerassociationGetObjectV3",
        new ApiException(400, "Missing the required parameter 'pkiEzsignfoldersignerassociationID' when calling ezsignfoldersignerassociationGetObjectV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}".replaceAll("\\{" + "pkiEzsignfoldersignerassociationID" + "\\}", apiInvoker.escapeString(pkiEzsignfoldersignerassociationID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignfoldersignerassociationGetObjectV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsignfoldersignerassociationGetObjectV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignfoldersignerassociationID 
  */
  public void ezsignfoldersignerassociationGetObjectV3 (Integer pkiEzsignfoldersignerassociationID, final Response.Listener<EzsignfoldersignerassociationGetObjectV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/3/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignfoldersignerassociationID" + "\\}", apiInvoker.escapeString(pkiEzsignfoldersignerassociationID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignfoldersignerassociationGetObjectV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignfoldersignerassociationGetObjectV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
