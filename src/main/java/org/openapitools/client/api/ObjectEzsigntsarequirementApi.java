...
public class ObjectEzsigntsarequirementApi {
  ...
  */
  public CommonGetAutocompleteDisabledV1Response ezsigntsarequirementGetAutocompleteV1 (String sSelector, Integer fkiEzsignfoldertypeID, String sQuery, HeaderAcceptLanguage acceptLanguage) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Retrieve Ezsigntsarequirements and IDs
   * Get the list of Ezsigntsarequirement to be used in a dropdown or autocomplete control.
   * @param sSelector The type of Ezsigntsarequirements to return   * @param fkiEzsignfoldertypeID    * @param sQuery Allow to filter the returned results   * @param acceptLanguage 
  */
  public void ezsigntsarequirementGetAutocompleteV1 (String sSelector, Integer fkiEzsignfoldertypeID, String sQuery, HeaderAcceptLanguage acceptLanguage, final Response.Listener<CommonGetAutocompleteDisabledV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
