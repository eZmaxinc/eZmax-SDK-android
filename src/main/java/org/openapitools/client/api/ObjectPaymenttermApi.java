...
import org.openapitools.client.model.PaymenttermDeleteObjectV1Response;
...
public class ObjectPaymenttermApi {
  ...
  */
  public PaymenttermDeleteObjectV1Response paymenttermDeleteObjectV1 (Integer pkiPaymenttermID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiPaymenttermID' is set
    if (pkiPaymenttermID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiPaymenttermID' when calling paymenttermDeleteObjectV1",
        new ApiException(400, "Missing the required parameter 'pkiPaymenttermID' when calling paymenttermDeleteObjectV1"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (PaymenttermDeleteObjectV1Response) ApiInvoker.deserialize(localVarResponse, "", PaymenttermDeleteObjectV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiPaymenttermID 
  */
  public void paymenttermDeleteObjectV1 (Integer pkiPaymenttermID, final Response.Listener<PaymenttermDeleteObjectV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "DELETE", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((PaymenttermDeleteObjectV1Response) ApiInvoker.deserialize(localVarResponse,  "", PaymenttermDeleteObjectV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
