...
public class ObjectUsergroupApi {
  ...
  */
  public CommonGetAutocompleteV1Response usergroupGetAutocompleteV1 (String sSelector, String sQuery, HeaderAcceptLanguage acceptLanguage) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Retrieve Usergroups and IDs
   * Get the list of Usergroup to be used in a dropdown or autocomplete control.
   * @param sSelector The type of Usergroups to return   * @param sQuery Allow to filter the returned results   * @param acceptLanguage 
  */
  public void usergroupGetAutocompleteV1 (String sSelector, String sQuery, HeaderAcceptLanguage acceptLanguage, final Response.Listener<CommonGetAutocompleteV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
