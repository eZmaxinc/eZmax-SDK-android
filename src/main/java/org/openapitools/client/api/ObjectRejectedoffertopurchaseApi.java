...
import org.openapitools.client.model.RejectedoffertopurchaseBatchDownloadV1Request;
import org.openapitools.client.model.RejectedoffertopurchaseGetAttachmentsV1Response;
...
import org.openapitools.client.model.RejectedoffertopurchaseGetListV1Response;
import org.openapitools.client.model.RejectedoffertopurchaseImportIntoEDMV1Request;
import org.openapitools.client.model.RejectedoffertopurchaseImportIntoEDMV1Response;
...
public class ObjectRejectedoffertopurchaseApi {
  ...
  * 
   ...
   * @return File
  */
  public File rejectedoffertopurchaseBatchDownloadV1 (Integer pkiRejectedoffertopurchaseID, RejectedoffertopurchaseBatchDownloadV1Request rejectedoffertopurchaseBatchDownloadV1Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (pkiRejectedoffertopurchaseID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiRejectedoffertopurchaseID' when calling rejectedoffertopurchaseBatchDownloadV1",
        new ApiException(400, "Missing the required parameter 'pkiRejectedoffertopurchaseID' when calling rejectedoffertopurchaseBatchDownloadV1"));
    }
    ...
    if (rejectedoffertopurchaseBatchDownloadV1Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'rejectedoffertopurchaseBatchDownloadV1Request' when calling rejectedoffertopurchaseBatchDownloadV1",
        new ApiException(400, "Missing the required parameter 'rejectedoffertopurchaseBatchDownloadV1Request' when calling rejectedoffertopurchaseBatchDownloadV1"));
    }

    // create path and map variables
    String path = "/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/batchDownload".replaceAll("\\{" + "pkiRejectedoffertopurchaseID" + "\\}", apiInvoker.escapeString(pkiRejectedoffertopurchaseID.toString()));
   ...
   * Download multiples attachments from a Rejectedoffertopurchase
   * 
   * @param pkiRejectedoffertopurchaseID    * @param rejectedoffertopurchaseBatchDownloadV1Request 
  */
  public void rejectedoffertopurchaseBatchDownloadV1 (Integer pkiRejectedoffertopurchaseID, RejectedoffertopurchaseBatchDownloadV1Request rejectedoffertopurchaseBatchDownloadV1Request, final Response.Listener<File> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = rejectedoffertopurchaseBatchDownloadV1Request;
    ...
    // create path and map variables
    String path = "/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/batchDownload".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiRejectedoffertopurchaseID" + "\\}", apiInvoker.escapeString(pkiRejectedoffertopurchaseID.toString()));
  ...
  */
  public RejectedoffertopurchaseGetAttachmentsV1Response rejectedoffertopurchaseGetAttachmentsV1 (Integer pkiRejectedoffertopurchaseID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiRejectedoffertopurchaseID' is set
    if (pkiRejectedoffertopurchaseID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiRejectedoffertopurchaseID' when calling rejectedoffertopurchaseGetAttachmentsV1",
        new ApiException(400, "Missing the required parameter 'pkiRejectedoffertopurchaseID' when calling rejectedoffertopurchaseGetAttachmentsV1"));
    }

    // create path and map variables
    String path = "/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/getAttachments".replaceAll("\\{" + "pkiRejectedoffertopurchaseID" + "\\}", apiInvoker.escapeString(pkiRejectedoffertopurchaseID.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (RejectedoffertopurchaseGetAttachmentsV1Response) ApiInvoker.deserialize(localVarResponse, "", RejectedoffertopurchaseGetAttachmentsV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiRejectedoffertopurchaseID 
  */
  public void rejectedoffertopurchaseGetAttachmentsV1 (Integer pkiRejectedoffertopurchaseID, final Response.Listener<RejectedoffertopurchaseGetAttachmentsV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/getAttachments".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiRejectedoffertopurchaseID" + "\\}", apiInvoker.escapeString(pkiRejectedoffertopurchaseID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((RejectedoffertopurchaseGetAttachmentsV1Response) ApiInvoker.deserialize(localVarResponse,  "", RejectedoffertopurchaseGetAttachmentsV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public RejectedoffertopurchaseGetListV1Response rejectedoffertopurchaseGetListV1 (String eOrderBy, Integer iRowMax, Integer iRowOffset, HeaderAcceptLanguage acceptLanguage, String sFilter) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;

    // create path and map variables
    String path = "/1/object/rejectedoffertopurchase/getList";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (RejectedoffertopurchaseGetListV1Response) ApiInvoker.deserialize(localVarResponse, "", RejectedoffertopurchaseGetListV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void rejectedoffertopurchaseGetListV1 (String eOrderBy, Integer iRowMax, Integer iRowOffset, HeaderAcceptLanguage acceptLanguage, String sFilter, final Response.Listener<RejectedoffertopurchaseGetListV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;


    // create path and map variables
    String path = "/1/object/rejectedoffertopurchase/getList".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((RejectedoffertopurchaseGetListV1Response) ApiInvoker.deserialize(localVarResponse,  "", RejectedoffertopurchaseGetListV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public RejectedoffertopurchaseImportIntoEDMV1Response rejectedoffertopurchaseImportIntoEDMV1 (Integer pkiRejectedoffertopurchaseID, RejectedoffertopurchaseImportIntoEDMV1Request rejectedoffertopurchaseImportIntoEDMV1Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = rejectedoffertopurchaseImportIntoEDMV1Request;
    // verify the required parameter 'pkiRejectedoffertopurchaseID' is set
    if (pkiRejectedoffertopurchaseID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiRejectedoffertopurchaseID' when calling rejectedoffertopurchaseImportIntoEDMV1",
        new ApiException(400, "Missing the required parameter 'pkiRejectedoffertopurchaseID' when calling rejectedoffertopurchaseImportIntoEDMV1"));
    }
    ...
    if (rejectedoffertopurchaseImportIntoEDMV1Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'rejectedoffertopurchaseImportIntoEDMV1Request' when calling rejectedoffertopurchaseImportIntoEDMV1",
        new ApiException(400, "Missing the required parameter 'rejectedoffertopurchaseImportIntoEDMV1Request' when calling rejectedoffertopurchaseImportIntoEDMV1"));
    }

    // create path and map variables
    String path = "/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/importIntoEDM".replaceAll("\\{" + "pkiRejectedoffertopurchaseID" + "\\}", apiInvoker.escapeString(pkiRejectedoffertopurchaseID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (RejectedoffertopurchaseImportIntoEDMV1Response) ApiInvoker.deserialize(localVarResponse, "", RejectedoffertopurchaseImportIntoEDMV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Import attachments into the Rejectedoffertopurchase
   * 
   * @param pkiRejectedoffertopurchaseID    * @param rejectedoffertopurchaseImportIntoEDMV1Request 
  */
  public void rejectedoffertopurchaseImportIntoEDMV1 (Integer pkiRejectedoffertopurchaseID, RejectedoffertopurchaseImportIntoEDMV1Request rejectedoffertopurchaseImportIntoEDMV1Request, final Response.Listener<RejectedoffertopurchaseImportIntoEDMV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = rejectedoffertopurchaseImportIntoEDMV1Request;
    ...
    // create path and map variables
    String path = "/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/importIntoEDM".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiRejectedoffertopurchaseID" + "\\}", apiInvoker.escapeString(pkiRejectedoffertopurchaseID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((RejectedoffertopurchaseImportIntoEDMV1Response) ApiInvoker.deserialize(localVarResponse,  "", RejectedoffertopurchaseImportIntoEDMV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
