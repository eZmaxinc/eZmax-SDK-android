...
import org.openapitools.client.model.EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request;
import org.openapitools.client.model.EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response;
...
import org.openapitools.client.model.EzsigntemplatepackageGetObjectV3Response;
import java.io.File;
...
public class ObjectEzsigntemplatepackageApi {
  ...
  */
  public EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response ezsigntemplatepackageEditEzsigntemplatepackagesignersV2 (Integer pkiEzsigntemplatepackageID, EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request;
    // verify the required parameter 'pkiEzsigntemplatepackageID' is set
    if (pkiEzsigntemplatepackageID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsigntemplatepackageID' when calling ezsigntemplatepackageEditEzsigntemplatepackagesignersV2",
        new ApiException(400, "Missing the required parameter 'pkiEzsigntemplatepackageID' when calling ezsigntemplatepackageEditEzsigntemplatepackagesignersV2"));
    }
    ...
    if (ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request' when calling ezsigntemplatepackageEditEzsigntemplatepackagesignersV2",
        new ApiException(400, "Missing the required parameter 'ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request' when calling ezsigntemplatepackageEditEzsigntemplatepackagesignersV2"));
    }

    // create path and map variables
    String path = "/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners".replaceAll("\\{" + "pkiEzsigntemplatepackageID" + "\\}", apiInvoker.escapeString(pkiEzsigntemplatepackageID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "PUT", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response) ApiInvoker.deserialize(localVarResponse, "", EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Edit multiple Ezsigntemplatepackagesigners
   * Using this endpoint, you can edit multiple Ezsigntemplatepackagesigners at the same time.
   * @param pkiEzsigntemplatepackageID    * @param ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request 
  */
  public void ezsigntemplatepackageEditEzsigntemplatepackagesignersV2 (Integer pkiEzsigntemplatepackageID, EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, final Response.Listener<EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request;
    ...
    // create path and map variables
    String path = "/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsigntemplatepackageID" + "\\}", apiInvoker.escapeString(pkiEzsigntemplatepackageID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "PUT", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response) ApiInvoker.deserialize(localVarResponse,  "", EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsigntemplatepackageGetObjectV3Response ezsigntemplatepackageGetObjectV3 (Integer pkiEzsigntemplatepackageID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsigntemplatepackageID' is set
    if (pkiEzsigntemplatepackageID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsigntemplatepackageID' when calling ezsigntemplatepackageGetObjectV3",
        new ApiException(400, "Missing the required parameter 'pkiEzsigntemplatepackageID' when calling ezsigntemplatepackageGetObjectV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}".replaceAll("\\{" + "pkiEzsigntemplatepackageID" + "\\}", apiInvoker.escapeString(pkiEzsigntemplatepackageID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsigntemplatepackageGetObjectV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsigntemplatepackageGetObjectV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsigntemplatepackageID 
  */
  public void ezsigntemplatepackageGetObjectV3 (Integer pkiEzsigntemplatepackageID, final Response.Listener<EzsigntemplatepackageGetObjectV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/3/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsigntemplatepackageID" + "\\}", apiInvoker.escapeString(pkiEzsigntemplatepackageID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsigntemplatepackageGetObjectV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsigntemplatepackageGetObjectV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
