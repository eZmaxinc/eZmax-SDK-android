...
import org.openapitools.client.model.UserlogintypeGetAutocompleteV2Response;
...
public class ObjectUserlogintypeApi {
  ...
  */
  public UserlogintypeGetAutocompleteV2Response userlogintypeGetAutocompleteV2 (String sSelector, Integer fkiEzsignfoldertypeID, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (sSelector == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'sSelector' when calling userlogintypeGetAutocompleteV2",
        new ApiException(400, "Missing the required parameter 'sSelector' when calling userlogintypeGetAutocompleteV2"));
    }

    // create path and map variables
    String path = "/2/object/userlogintype/getAutocomplete/{sSelector}".replaceAll("\\{" + "sSelector" + "\\}", apiInvoker.escapeString(sSelector.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (UserlogintypeGetAutocompleteV2Response) ApiInvoker.deserialize(localVarResponse, "", UserlogintypeGetAutocompleteV2Response.class);
      } else {
         return null;
      }
  ...
  */
  public void userlogintypeGetAutocompleteV2 (String sSelector, Integer fkiEzsignfoldertypeID, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final Response.Listener<UserlogintypeGetAutocompleteV2Response> responseListener, final Response.ErrorListener errorListener) {
    ...
    // create path and map variables
    String path = "/2/object/userlogintype/getAutocomplete/{sSelector}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "sSelector" + "\\}", apiInvoker.escapeString(sSelector.toString()));
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((UserlogintypeGetAutocompleteV2Response) ApiInvoker.deserialize(localVarResponse,  "", UserlogintypeGetAutocompleteV2Response.class));
