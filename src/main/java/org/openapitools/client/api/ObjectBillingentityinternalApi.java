...
public class ObjectBillingentityinternalApi {
  ...
  */
  public CommonGetAutocompleteV1Response billingentityinternalGetAutocompleteV1 (String sSelector, String sQuery, HeaderAcceptLanguage acceptLanguage) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * Retrieve Billingentityinternals and IDs
   * Get the list of Billingentityinternal to be used in a dropdown or autocomplete control.
   * @param sSelector The type of Billingentityinternals to return   * @param sQuery Allow to filter the returned results   * @param acceptLanguage 
  */
  public void billingentityinternalGetAutocompleteV1 (String sSelector, String sQuery, HeaderAcceptLanguage acceptLanguage, final Response.Listener<CommonGetAutocompleteV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
