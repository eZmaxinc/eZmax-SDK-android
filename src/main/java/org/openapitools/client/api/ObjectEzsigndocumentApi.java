...
public class ObjectEzsigndocumentApi {
  ...
  */
   ...
   * Modify an existing Ezsigndocument
   * 
   * @param pkiEzsigndocumentID The unique ID of the Ezsigndocument   * @param ezsigndocumentEditObjectV1Request 
  */
  ...
  * 
   ...
   * @return void
  */
  public void ezsigndocumentGetObjectGetChildrenV1 (Integer pkiEzsigndocumentID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsigndocumentID' is set
    if (pkiEzsigndocumentID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsigndocumentID' when calling ezsigndocumentGetObjectGetChildrenV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsigndocumentID' when calling ezsigndocumentGetObjectGetChildrenV1"));
    }
   ...
   * @param pkiEzsigndocumentID The unique ID of the Ezsigndocument
  */
  public void ezsigndocumentGetObjectGetChildrenV1 (Integer pkiEzsigndocumentID, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
