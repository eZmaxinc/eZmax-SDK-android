...
import org.openapitools.client.model.EzsignbulksenddocumentmappingGetObjectV3Response;
...
public class ObjectEzsignbulksenddocumentmappingApi {
  ...
  */
  public EzsignbulksenddocumentmappingGetObjectV3Response ezsignbulksenddocumentmappingGetObjectV3 (Integer pkiEzsignbulksenddocumentmappingID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignbulksenddocumentmappingID' is set
    if (pkiEzsignbulksenddocumentmappingID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignbulksenddocumentmappingID' when calling ezsignbulksenddocumentmappingGetObjectV3",
        new ApiException(400, "Missing the required parameter 'pkiEzsignbulksenddocumentmappingID' when calling ezsignbulksenddocumentmappingGetObjectV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}".replaceAll("\\{" + "pkiEzsignbulksenddocumentmappingID" + "\\}", apiInvoker.escapeString(pkiEzsignbulksenddocumentmappingID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignbulksenddocumentmappingGetObjectV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsignbulksenddocumentmappingGetObjectV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignbulksenddocumentmappingID 
  */
  public void ezsignbulksenddocumentmappingGetObjectV3 (Integer pkiEzsignbulksenddocumentmappingID, final Response.Listener<EzsignbulksenddocumentmappingGetObjectV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignbulksenddocumentmappingID" + "\\}", apiInvoker.escapeString(pkiEzsignbulksenddocumentmappingID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignbulksenddocumentmappingGetObjectV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignbulksenddocumentmappingGetObjectV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
