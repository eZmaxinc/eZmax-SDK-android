...
import org.openapitools.client.model.EzsignbulksendsignermappingGetObjectV1Response;
...
public class ObjectEzsignbulksendsignermappingApi {
  ...
  */
  public EzsignbulksendsignermappingGetObjectV1Response ezsignbulksendsignermappingGetObjectV1 (Integer pkiEzsignbulksendsignermappingID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignbulksendsignermappingID' is set
    if (pkiEzsignbulksendsignermappingID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignbulksendsignermappingID' when calling ezsignbulksendsignermappingGetObjectV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignbulksendsignermappingID' when calling ezsignbulksendsignermappingGetObjectV1"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (EzsignbulksendsignermappingGetObjectV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignbulksendsignermappingGetObjectV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignbulksendsignermappingID 
  */
  public void ezsignbulksendsignermappingGetObjectV1 (Integer pkiEzsignbulksendsignermappingID, final Response.Listener<EzsignbulksendsignermappingGetObjectV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignbulksendsignermappingGetObjectV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignbulksendsignermappingGetObjectV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
