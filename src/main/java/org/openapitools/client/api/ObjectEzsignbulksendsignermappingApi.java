...
import org.openapitools.client.model.EzsignbulksendsignermappingCreateObjectV2Request;
import org.openapitools.client.model.EzsignbulksendsignermappingCreateObjectV2Response;
...
import org.openapitools.client.model.EzsignbulksendsignermappingGetObjectV3Response;
...
public class ObjectEzsignbulksendsignermappingApi {
  ...
  */
  public EzsignbulksendsignermappingCreateObjectV2Response ezsignbulksendsignermappingCreateObjectV2 (EzsignbulksendsignermappingCreateObjectV2Request ezsignbulksendsignermappingCreateObjectV2Request) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (ezsignbulksendsignermappingCreateObjectV2Request == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ezsignbulksendsignermappingCreateObjectV2Request' when calling ezsignbulksendsignermappingCreateObjectV2",
        new ApiException(400, "Missing the required parameter 'ezsignbulksendsignermappingCreateObjectV2Request' when calling ezsignbulksendsignermappingCreateObjectV2"));
    }

    // create path and map variables
    String path = "/2/object/ezsignbulksendsignermapping";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignbulksendsignermappingCreateObjectV2Response) ApiInvoker.deserialize(localVarResponse, "", EzsignbulksendsignermappingCreateObjectV2Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param ezsignbulksendsignermappingCreateObjectV2Request 
  */
  public void ezsignbulksendsignermappingCreateObjectV2 (EzsignbulksendsignermappingCreateObjectV2Request ezsignbulksendsignermappingCreateObjectV2Request, final Response.Listener<EzsignbulksendsignermappingCreateObjectV2Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ezsignbulksendsignermappingCreateObjectV2Request;
    ...
    // create path and map variables
    String path = "/2/object/ezsignbulksendsignermapping".replaceAll("\\{format\\}","json");
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignbulksendsignermappingCreateObjectV2Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignbulksendsignermappingCreateObjectV2Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public EzsignbulksendsignermappingGetObjectV3Response ezsignbulksendsignermappingGetObjectV3 (Integer pkiEzsignbulksendsignermappingID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignbulksendsignermappingID' is set
    if (pkiEzsignbulksendsignermappingID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignbulksendsignermappingID' when calling ezsignbulksendsignermappingGetObjectV3",
        new ApiException(400, "Missing the required parameter 'pkiEzsignbulksendsignermappingID' when calling ezsignbulksendsignermappingGetObjectV3"));
    }

    // create path and map variables
    String path = "/3/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}".replaceAll("\\{" + "pkiEzsignbulksendsignermappingID" + "\\}", apiInvoker.escapeString(pkiEzsignbulksendsignermappingID.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (EzsignbulksendsignermappingGetObjectV3Response) ApiInvoker.deserialize(localVarResponse, "", EzsignbulksendsignermappingGetObjectV3Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignbulksendsignermappingID 
  */
  public void ezsignbulksendsignermappingGetObjectV3 (Integer pkiEzsignbulksendsignermappingID, final Response.Listener<EzsignbulksendsignermappingGetObjectV3Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/3/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "pkiEzsignbulksendsignermappingID" + "\\}", apiInvoker.escapeString(pkiEzsignbulksendsignermappingID.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignbulksendsignermappingGetObjectV3Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignbulksendsignermappingGetObjectV3Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
