...
import org.openapitools.client.model.EzsignformfieldgroupGetObjectV1Response;
...
public class ObjectEzsignformfieldgroupApi {
  ...
  */
  public EzsignformfieldgroupGetObjectV1Response ezsignformfieldgroupGetObjectV1 (Integer pkiEzsignformfieldgroupID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiEzsignformfieldgroupID' is set
    if (pkiEzsignformfieldgroupID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiEzsignformfieldgroupID' when calling ezsignformfieldgroupGetObjectV1",
        new ApiException(400, "Missing the required parameter 'pkiEzsignformfieldgroupID' when calling ezsignformfieldgroupGetObjectV1"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (EzsignformfieldgroupGetObjectV1Response) ApiInvoker.deserialize(localVarResponse, "", EzsignformfieldgroupGetObjectV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiEzsignformfieldgroupID 
  */
  public void ezsignformfieldgroupGetObjectV1 (Integer pkiEzsignformfieldgroupID, final Response.Listener<EzsignformfieldgroupGetObjectV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((EzsignformfieldgroupGetObjectV1Response) ApiInvoker.deserialize(localVarResponse,  "", EzsignformfieldgroupGetObjectV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
