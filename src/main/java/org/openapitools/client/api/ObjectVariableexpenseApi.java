...
import org.openapitools.client.model.VariableexpenseDeleteObjectV1Response;
...
public class ObjectVariableexpenseApi {
  ...
  */
  public VariableexpenseDeleteObjectV1Response variableexpenseDeleteObjectV1 (Integer pkiVariableexpenseID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'pkiVariableexpenseID' is set
    if (pkiVariableexpenseID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'pkiVariableexpenseID' when calling variableexpenseDeleteObjectV1",
        new ApiException(400, "Missing the required parameter 'pkiVariableexpenseID' when calling variableexpenseDeleteObjectV1"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (VariableexpenseDeleteObjectV1Response) ApiInvoker.deserialize(localVarResponse, "", VariableexpenseDeleteObjectV1Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param pkiVariableexpenseID The unique ID of the Variableexpense
  */
  public void variableexpenseDeleteObjectV1 (Integer pkiVariableexpenseID, final Response.Listener<VariableexpenseDeleteObjectV1Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "DELETE", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((VariableexpenseDeleteObjectV1Response) ApiInvoker.deserialize(localVarResponse,  "", VariableexpenseDeleteObjectV1Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
