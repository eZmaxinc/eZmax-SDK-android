...
public class EzsignsignergroupmembershipResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignsignergroupmembershipID == null ? ezsignsignergroupmembershipResponse.pkiEzsignsignergroupmembershipID == null : this.pkiEzsignsignergroupmembershipID.equals(ezsignsignergroupmembershipResponse.pkiEzsignsignergroupmembershipID)) &&
        (this.fkiEzsignsignergroupID == null ? ezsignsignergroupmembershipResponse.fkiEzsignsignergroupID == null : this.fkiEzsignsignergroupID.equals(ezsignsignergroupmembershipResponse.fkiEzsignsignergroupID)) &&
        (this.fkiEzsignsignerID == null ? ezsignsignergroupmembershipResponse.fkiEzsignsignerID == null : this.fkiEzsignsignerID.equals(ezsignsignergroupmembershipResponse.fkiEzsignsignerID)) &&
        (this.fkiUserID == null ? ezsignsignergroupmembershipResponse.fkiUserID == null : this.fkiUserID.equals(ezsignsignergroupmembershipResponse.fkiUserID)) &&
        (this.fkiUsergroupID == null ? ezsignsignergroupmembershipResponse.fkiUsergroupID == null : this.fkiUsergroupID.equals(ezsignsignergroupmembershipResponse.fkiUsergroupID));
  }
