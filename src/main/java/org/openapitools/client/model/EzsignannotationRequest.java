...
public class EzsignannotationRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignannotationID == null ? ezsignannotationRequest.pkiEzsignannotationID == null : this.pkiEzsignannotationID.equals(ezsignannotationRequest.pkiEzsignannotationID)) &&
        (this.fkiEzsigndocumentID == null ? ezsignannotationRequest.fkiEzsigndocumentID == null : this.fkiEzsigndocumentID.equals(ezsignannotationRequest.fkiEzsigndocumentID)) &&
        (this.eEzsignannotationHorizontalalignment == null ? ezsignannotationRequest.eEzsignannotationHorizontalalignment == null : this.eEzsignannotationHorizontalalignment.equals(ezsignannotationRequest.eEzsignannotationHorizontalalignment)) &&
        (this.eEzsignannotationVerticalalignment == null ? ezsignannotationRequest.eEzsignannotationVerticalalignment == null : this.eEzsignannotationVerticalalignment.equals(ezsignannotationRequest.eEzsignannotationVerticalalignment)) &&
        (this.eEzsignannotationType == null ? ezsignannotationRequest.eEzsignannotationType == null : this.eEzsignannotationType.equals(ezsignannotationRequest.eEzsignannotationType)) &&
        (this.iEzsignannotationX == null ? ezsignannotationRequest.iEzsignannotationX == null : this.iEzsignannotationX.equals(ezsignannotationRequest.iEzsignannotationX)) &&
        (this.iEzsignannotationY == null ? ezsignannotationRequest.iEzsignannotationY == null : this.iEzsignannotationY.equals(ezsignannotationRequest.iEzsignannotationY)) &&
        (this.iEzsignannotationWidth == null ? ezsignannotationRequest.iEzsignannotationWidth == null : this.iEzsignannotationWidth.equals(ezsignannotationRequest.iEzsignannotationWidth)) &&
        (this.iEzsignannotationHeight == null ? ezsignannotationRequest.iEzsignannotationHeight == null : this.iEzsignannotationHeight.equals(ezsignannotationRequest.iEzsignannotationHeight)) &&
        (this.sEzsignannotationText == null ? ezsignannotationRequest.sEzsignannotationText == null : this.sEzsignannotationText.equals(ezsignannotationRequest.sEzsignannotationText)) &&
        (this.iEzsignpagePagenumber == null ? ezsignannotationRequest.iEzsignpagePagenumber == null : this.iEzsignpagePagenumber.equals(ezsignannotationRequest.iEzsignpagePagenumber));
  }
