...
public class UserResponseCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiUserID == null ? userResponseCompound.pkiUserID == null : this.pkiUserID.equals(userResponseCompound.pkiUserID)) &&
        (this.fkiAgentID == null ? userResponseCompound.fkiAgentID == null : this.fkiAgentID.equals(userResponseCompound.fkiAgentID)) &&
        ...
        (this.sDepartmentNameX == null ? userResponseCompound.sDepartmentNameX == null : this.sDepartmentNameX.equals(userResponseCompound.sDepartmentNameX)) &&
        (this.fkiTimezoneID == null ? userResponseCompound.fkiTimezoneID == null : this.fkiTimezoneID.equals(userResponseCompound.fkiTimezoneID)) &&
        (this.sTimezoneName == null ? userResponseCompound.sTimezoneName == null : this.sTimezoneName.equals(userResponseCompound.sTimezoneName)) &&
        ...
        (this.sLanguageNameX == null ? userResponseCompound.sLanguageNameX == null : this.sLanguageNameX.equals(userResponseCompound.sLanguageNameX)) &&
        (this.objEmail == null ? userResponseCompound.objEmail == null : this.objEmail.equals(userResponseCompound.objEmail)) &&
        (this.fkiBillingentityinternalID == null ? userResponseCompound.fkiBillingentityinternalID == null : this.fkiBillingentityinternalID.equals(userResponseCompound.fkiBillingentityinternalID)) &&
        (this.sBillingentityinternalDescriptionX == null ? userResponseCompound.sBillingentityinternalDescriptionX == null : this.sBillingentityinternalDescriptionX.equals(userResponseCompound.sBillingentityinternalDescriptionX)) &&
        (this.objPhoneHome == null ? userResponseCompound.objPhoneHome == null : this.objPhoneHome.equals(userResponseCompound.objPhoneHome)) &&
        (this.objPhoneSMS == null ? userResponseCompound.objPhoneSMS == null : this.objPhoneSMS.equals(userResponseCompound.objPhoneSMS)) &&
        (this.fkiSecretquestionID == null ? userResponseCompound.fkiSecretquestionID == null : this.fkiSecretquestionID.equals(userResponseCompound.fkiSecretquestionID)) &&
        (this.fkiModuleIDForm == null ? userResponseCompound.fkiModuleIDForm == null : this.fkiModuleIDForm.equals(userResponseCompound.fkiModuleIDForm)) &&
        (this.sModuleNameX == null ? userResponseCompound.sModuleNameX == null : this.sModuleNameX.equals(userResponseCompound.sModuleNameX)) &&
        (this.eUserOrigin == null ? userResponseCompound.eUserOrigin == null : this.eUserOrigin.equals(userResponseCompound.eUserOrigin)) &&
        (this.eUserType == null ? userResponseCompound.eUserType == null : this.eUserType.equals(userResponseCompound.eUserType)) &&
        (this.eUserLogintype == null ? userResponseCompound.eUserLogintype == null : this.eUserLogintype.equals(userResponseCompound.eUserLogintype)) &&
