...
public class DiscussionmembershipRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiDiscussionmembershipID == null ? discussionmembershipRequest.pkiDiscussionmembershipID == null : this.pkiDiscussionmembershipID.equals(discussionmembershipRequest.pkiDiscussionmembershipID)) &&
        (this.fkiDiscussionID == null ? discussionmembershipRequest.fkiDiscussionID == null : this.fkiDiscussionID.equals(discussionmembershipRequest.fkiDiscussionID)) &&
        (this.fkiUserID == null ? discussionmembershipRequest.fkiUserID == null : this.fkiUserID.equals(discussionmembershipRequest.fkiUserID)) &&
        (this.fkiUsergroupID == null ? discussionmembershipRequest.fkiUsergroupID == null : this.fkiUsergroupID.equals(discussionmembershipRequest.fkiUsergroupID)) &&
        (this.fkiModulesectionID == null ? discussionmembershipRequest.fkiModulesectionID == null : this.fkiModulesectionID.equals(discussionmembershipRequest.fkiModulesectionID)) &&
        (this.dtDiscussionmembershipJoined == null ? discussionmembershipRequest.dtDiscussionmembershipJoined == null : this.dtDiscussionmembershipJoined.equals(discussionmembershipRequest.dtDiscussionmembershipJoined));
  }
