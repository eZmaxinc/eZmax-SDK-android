...
import java.util.*;
import org.openapitools.client.model.AttachmentResponseCompound;
 ...
 **/
@ApiModel(description = "A Custom Attachment Object")
public class CustomAttachmentResponse {
  ...
  @SerializedName("objAttachmentProof")
  private AttachmentResponseCompound objAttachmentProof = null;
  @SerializedName("objAttachmentProofdocument")
  private AttachmentResponseCompound objAttachmentProofdocument = null;
  @SerializedName("a_objAttachmentAttachment")
  private List<AttachmentResponseCompound> aObjAttachmentAttachment = null;
  @SerializedName("a_objAttachmentVersion")
  private List<AttachmentResponseCompound> aObjAttachmentVersion = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiAttachmentID == null ? customAttachmentResponse.pkiAttachmentID == null : this.pkiAttachmentID.equals(customAttachmentResponse.pkiAttachmentID)) &&
        (this.fkiComputerID == null ? customAttachmentResponse.fkiComputerID == null : this.fkiComputerID.equals(customAttachmentResponse.fkiComputerID)) &&
        (this.fkiAdjustmentID == null ? customAttachmentResponse.fkiAdjustmentID == null : this.fkiAdjustmentID.equals(customAttachmentResponse.fkiAdjustmentID)) &&
        (this.fkiAgentID == null ? customAttachmentResponse.fkiAgentID == null : this.fkiAgentID.equals(customAttachmentResponse.fkiAgentID)) &&
        (this.fkiBankaccountID == null ? customAttachmentResponse.fkiBankaccountID == null : this.fkiBankaccountID.equals(customAttachmentResponse.fkiBankaccountID)) &&
        (this.fkiBrokerID == null ? customAttachmentResponse.fkiBrokerID == null : this.fkiBrokerID.equals(customAttachmentResponse.fkiBrokerID)) &&
        (this.fkiCommissionadvanceID == null ? customAttachmentResponse.fkiCommissionadvanceID == null : this.fkiCommissionadvanceID.equals(customAttachmentResponse.fkiCommissionadvanceID)) &&
        (this.fkiCommunicationID == null ? customAttachmentResponse.fkiCommunicationID == null : this.fkiCommunicationID.equals(customAttachmentResponse.fkiCommunicationID)) &&
        (this.fkiCustomerID == null ? customAttachmentResponse.fkiCustomerID == null : this.fkiCustomerID.equals(customAttachmentResponse.fkiCustomerID)) &&
        (this.fkiCustomertemplateID == null ? customAttachmentResponse.fkiCustomertemplateID == null : this.fkiCustomertemplateID.equals(customAttachmentResponse.fkiCustomertemplateID)) &&
        (this.fkiDepositID == null ? customAttachmentResponse.fkiDepositID == null : this.fkiDepositID.equals(customAttachmentResponse.fkiDepositID)) &&
        (this.fkiDeposittransitchequeID == null ? customAttachmentResponse.fkiDeposittransitchequeID == null : this.fkiDeposittransitchequeID.equals(customAttachmentResponse.fkiDeposittransitchequeID)) &&
        (this.fkiElectronicfundstransferID == null ? customAttachmentResponse.fkiElectronicfundstransferID == null : this.fkiElectronicfundstransferID.equals(customAttachmentResponse.fkiElectronicfundstransferID)) &&
        (this.fkiEmployeeID == null ? customAttachmentResponse.fkiEmployeeID == null : this.fkiEmployeeID.equals(customAttachmentResponse.fkiEmployeeID)) &&
        (this.fkiExternalbrokerID == null ? customAttachmentResponse.fkiExternalbrokerID == null : this.fkiExternalbrokerID.equals(customAttachmentResponse.fkiExternalbrokerID)) &&
        (this.fkiEzcomadvanceserverID == null ? customAttachmentResponse.fkiEzcomadvanceserverID == null : this.fkiEzcomadvanceserverID.equals(customAttachmentResponse.fkiEzcomadvanceserverID)) &&
        (this.fkiEzcomcompanyID == null ? customAttachmentResponse.fkiEzcomcompanyID == null : this.fkiEzcomcompanyID.equals(customAttachmentResponse.fkiEzcomcompanyID)) &&
        (this.fkiEzsigndocumentID == null ? customAttachmentResponse.fkiEzsigndocumentID == null : this.fkiEzsigndocumentID.equals(customAttachmentResponse.fkiEzsigndocumentID)) &&
        (this.fkiGhacqcontractID == null ? customAttachmentResponse.fkiGhacqcontractID == null : this.fkiGhacqcontractID.equals(customAttachmentResponse.fkiGhacqcontractID)) &&
        (this.fkiInscriptionID == null ? customAttachmentResponse.fkiInscriptionID == null : this.fkiInscriptionID.equals(customAttachmentResponse.fkiInscriptionID)) &&
        (this.fkiInscriptiontempID == null ? customAttachmentResponse.fkiInscriptiontempID == null : this.fkiInscriptiontempID.equals(customAttachmentResponse.fkiInscriptiontempID)) &&
        (this.fkiInscriptionnotauthenticatedID == null ? customAttachmentResponse.fkiInscriptionnotauthenticatedID == null : this.fkiInscriptionnotauthenticatedID.equals(customAttachmentResponse.fkiInscriptionnotauthenticatedID)) &&
        (this.fkiInvoiceID == null ? customAttachmentResponse.fkiInvoiceID == null : this.fkiInvoiceID.equals(customAttachmentResponse.fkiInvoiceID)) &&
        (this.fkiBuyercontractID == null ? customAttachmentResponse.fkiBuyercontractID == null : this.fkiBuyercontractID.equals(customAttachmentResponse.fkiBuyercontractID)) &&
        (this.fkiFranchisebrokerID == null ? customAttachmentResponse.fkiFranchisebrokerID == null : this.fkiFranchisebrokerID.equals(customAttachmentResponse.fkiFranchisebrokerID)) &&
        (this.fkiFranchiseagenceID == null ? customAttachmentResponse.fkiFranchiseagenceID == null : this.fkiFranchiseagenceID.equals(customAttachmentResponse.fkiFranchiseagenceID)) &&
        (this.fkiFranchiseofficeID == null ? customAttachmentResponse.fkiFranchiseofficeID == null : this.fkiFranchiseofficeID.equals(customAttachmentResponse.fkiFranchiseofficeID)) &&
        (this.fkiFranchisefranchiseID == null ? customAttachmentResponse.fkiFranchisefranchiseID == null : this.fkiFranchisefranchiseID.equals(customAttachmentResponse.fkiFranchisefranchiseID)) &&
        (this.fkiFranchisecomplaintID == null ? customAttachmentResponse.fkiFranchisecomplaintID == null : this.fkiFranchisecomplaintID.equals(customAttachmentResponse.fkiFranchisecomplaintID)) &&
        (this.fkiLeadID == null ? customAttachmentResponse.fkiLeadID == null : this.fkiLeadID.equals(customAttachmentResponse.fkiLeadID)) &&
        (this.fkiMarketingprogramID == null ? customAttachmentResponse.fkiMarketingprogramID == null : this.fkiMarketingprogramID.equals(customAttachmentResponse.fkiMarketingprogramID)) &&
        (this.fkiMarketingfollowID == null ? customAttachmentResponse.fkiMarketingfollowID == null : this.fkiMarketingfollowID.equals(customAttachmentResponse.fkiMarketingfollowID)) &&
        (this.fkiNotaryID == null ? customAttachmentResponse.fkiNotaryID == null : this.fkiNotaryID.equals(customAttachmentResponse.fkiNotaryID)) &&
        (this.fkiOfficetaxreportID == null ? customAttachmentResponse.fkiOfficetaxreportID == null : this.fkiOfficetaxreportID.equals(customAttachmentResponse.fkiOfficetaxreportID)) &&
        (this.fkiOtherincomeID == null ? customAttachmentResponse.fkiOtherincomeID == null : this.fkiOtherincomeID.equals(customAttachmentResponse.fkiOtherincomeID)) &&
        (this.fkiPaymentpreparationID == null ? customAttachmentResponse.fkiPaymentpreparationID == null : this.fkiPaymentpreparationID.equals(customAttachmentResponse.fkiPaymentpreparationID)) &&
        (this.fkiPurchaseID == null ? customAttachmentResponse.fkiPurchaseID == null : this.fkiPurchaseID.equals(customAttachmentResponse.fkiPurchaseID)) &&
        (this.fkiSalaryID == null ? customAttachmentResponse.fkiSalaryID == null : this.fkiSalaryID.equals(customAttachmentResponse.fkiSalaryID)) &&
        (this.fkiSupplierID == null ? customAttachmentResponse.fkiSupplierID == null : this.fkiSupplierID.equals(customAttachmentResponse.fkiSupplierID)) &&
        (this.fkiTranqcontractID == null ? customAttachmentResponse.fkiTranqcontractID == null : this.fkiTranqcontractID.equals(customAttachmentResponse.fkiTranqcontractID)) &&
        (this.fkiTemplateID == null ? customAttachmentResponse.fkiTemplateID == null : this.fkiTemplateID.equals(customAttachmentResponse.fkiTemplateID)) &&
        (this.fkiInscriptionchecklistID == null ? customAttachmentResponse.fkiInscriptionchecklistID == null : this.fkiInscriptionchecklistID.equals(customAttachmentResponse.fkiInscriptionchecklistID)) &&
        (this.fkiFolderID == null ? customAttachmentResponse.fkiFolderID == null : this.fkiFolderID.equals(customAttachmentResponse.fkiFolderID)) &&
        (this.fkiRejectedoffertopurchaseID == null ? customAttachmentResponse.fkiRejectedoffertopurchaseID == null : this.fkiRejectedoffertopurchaseID.equals(customAttachmentResponse.fkiRejectedoffertopurchaseID)) &&
        (this.fkiDisclosureID == null ? customAttachmentResponse.fkiDisclosureID == null : this.fkiDisclosureID.equals(customAttachmentResponse.fkiDisclosureID)) &&
        (this.fkiReconciliationID == null ? customAttachmentResponse.fkiReconciliationID == null : this.fkiReconciliationID.equals(customAttachmentResponse.fkiReconciliationID)) &&
        (this.fkiEzsigndocumentIDReference == null ? customAttachmentResponse.fkiEzsigndocumentIDReference == null : this.fkiEzsigndocumentIDReference.equals(customAttachmentResponse.fkiEzsigndocumentIDReference)) &&
        (this.eAttachmentDocumenttype == null ? customAttachmentResponse.eAttachmentDocumenttype == null : this.eAttachmentDocumenttype.equals(customAttachmentResponse.eAttachmentDocumenttype)) &&
        (this.sAttachmentName == null ? customAttachmentResponse.sAttachmentName == null : this.sAttachmentName.equals(customAttachmentResponse.sAttachmentName)) &&
        (this.sAttachmentCategory == null ? customAttachmentResponse.sAttachmentCategory == null : this.sAttachmentCategory.equals(customAttachmentResponse.sAttachmentCategory)) &&
        (this.eAttachmentPrivacy == null ? customAttachmentResponse.eAttachmentPrivacy == null : this.eAttachmentPrivacy.equals(customAttachmentResponse.eAttachmentPrivacy)) &&
        (this.fkiUserIDSpecific == null ? customAttachmentResponse.fkiUserIDSpecific == null : this.fkiUserIDSpecific.equals(customAttachmentResponse.fkiUserIDSpecific)) &&
        (this.eAttachmentType == null ? customAttachmentResponse.eAttachmentType == null : this.eAttachmentType.equals(customAttachmentResponse.eAttachmentType)) &&
        (this.iAttachmentSize == null ? customAttachmentResponse.iAttachmentSize == null : this.iAttachmentSize.equals(customAttachmentResponse.iAttachmentSize)) &&
        (this.iAttachmentEDMmoduleflag == null ? customAttachmentResponse.iAttachmentEDMmoduleflag == null : this.iAttachmentEDMmoduleflag.equals(customAttachmentResponse.iAttachmentEDMmoduleflag)) &&
        (this.sAttachmentMD5 == null ? customAttachmentResponse.sAttachmentMD5 == null : this.sAttachmentMD5.equals(customAttachmentResponse.sAttachmentMD5)) &&
        (this.bAttachmentDeleted == null ? customAttachmentResponse.bAttachmentDeleted == null : this.bAttachmentDeleted.equals(customAttachmentResponse.bAttachmentDeleted)) &&
        (this.bAttachmentValid == null ? customAttachmentResponse.bAttachmentValid == null : this.bAttachmentValid.equals(customAttachmentResponse.bAttachmentValid)) &&
        (this.eAttachmentVerified == null ? customAttachmentResponse.eAttachmentVerified == null : this.eAttachmentVerified.equals(customAttachmentResponse.eAttachmentVerified)) &&
        (this.tAttachmentRejectioncomment == null ? customAttachmentResponse.tAttachmentRejectioncomment == null : this.tAttachmentRejectioncomment.equals(customAttachmentResponse.tAttachmentRejectioncomment)) &&
        (this.fkiUserIDOwner == null ? customAttachmentResponse.fkiUserIDOwner == null : this.fkiUserIDOwner.equals(customAttachmentResponse.fkiUserIDOwner)) &&
        (this.objAudit == null ? customAttachmentResponse.objAudit == null : this.objAudit.equals(customAttachmentResponse.objAudit)) &&
        (this.objAttachmentProof == null ? customAttachmentResponse.objAttachmentProof == null : this.objAttachmentProof.equals(customAttachmentResponse.objAttachmentProof)) &&
        (this.objAttachmentProofdocument == null ? customAttachmentResponse.objAttachmentProofdocument == null : this.objAttachmentProofdocument.equals(customAttachmentResponse.objAttachmentProofdocument)) &&
        (this.aObjAttachmentAttachment == null ? customAttachmentResponse.aObjAttachmentAttachment == null : this.aObjAttachmentAttachment.equals(customAttachmentResponse.aObjAttachmentAttachment)) &&
        (this.aObjAttachmentVersion == null ? customAttachmentResponse.aObjAttachmentVersion == null : this.aObjAttachmentVersion.equals(customAttachmentResponse.aObjAttachmentVersion));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.objAttachmentProof == null ? 0: this.objAttachmentProof.hashCode());
    result = 31 * result + (this.objAttachmentProofdocument == null ? 0: this.objAttachmentProofdocument.hashCode());
    result = 31 * result + (this.aObjAttachmentAttachment == null ? 0: this.aObjAttachmentAttachment.hashCode());
    result = 31 * result + (this.aObjAttachmentVersion == null ? 0: this.aObjAttachmentVersion.hashCode());
    return result;
  }
