...
public class EzsignbulksendsignermappingResponseCompoundV3 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignbulksendsignermappingID == null ? ezsignbulksendsignermappingResponseCompoundV3.pkiEzsignbulksendsignermappingID == null : this.pkiEzsignbulksendsignermappingID.equals(ezsignbulksendsignermappingResponseCompoundV3.pkiEzsignbulksendsignermappingID)) &&
        (this.fkiEzsignbulksendID == null ? ezsignbulksendsignermappingResponseCompoundV3.fkiEzsignbulksendID == null : this.fkiEzsignbulksendID.equals(ezsignbulksendsignermappingResponseCompoundV3.fkiEzsignbulksendID)) &&
        (this.fkiUserID == null ? ezsignbulksendsignermappingResponseCompoundV3.fkiUserID == null : this.fkiUserID.equals(ezsignbulksendsignermappingResponseCompoundV3.fkiUserID)) &&
        (this.eEzsignbulksendsignermappingRole == null ? ezsignbulksendsignermappingResponseCompoundV3.eEzsignbulksendsignermappingRole == null : this.eEzsignbulksendsignermappingRole.equals(ezsignbulksendsignermappingResponseCompoundV3.eEzsignbulksendsignermappingRole)) &&
        (this.sEzsignbulksendsignermappingDescription == null ? ezsignbulksendsignermappingResponseCompoundV3.sEzsignbulksendsignermappingDescription == null : this.sEzsignbulksendsignermappingDescription.equals(ezsignbulksendsignermappingResponseCompoundV3.sEzsignbulksendsignermappingDescription));
  }
