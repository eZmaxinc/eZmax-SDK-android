...
public class UserRequestCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiUserID == null ? userRequestCompound.pkiUserID == null : this.pkiUserID.equals(userRequestCompound.pkiUserID)) &&
        (this.fkiAgentID == null ? userRequestCompound.fkiAgentID == null : this.fkiAgentID.equals(userRequestCompound.fkiAgentID)) &&
        (this.fkiBrokerID == null ? userRequestCompound.fkiBrokerID == null : this.fkiBrokerID.equals(userRequestCompound.fkiBrokerID)) &&
        (this.fkiAssistantID == null ? userRequestCompound.fkiAssistantID == null : this.fkiAssistantID.equals(userRequestCompound.fkiAssistantID)) &&
        (this.fkiEmployeeID == null ? userRequestCompound.fkiEmployeeID == null : this.fkiEmployeeID.equals(userRequestCompound.fkiEmployeeID)) &&
        (this.fkiCompanyIDDefault == null ? userRequestCompound.fkiCompanyIDDefault == null : this.fkiCompanyIDDefault.equals(userRequestCompound.fkiCompanyIDDefault)) &&
        (this.fkiDepartmentIDDefault == null ? userRequestCompound.fkiDepartmentIDDefault == null : this.fkiDepartmentIDDefault.equals(userRequestCompound.fkiDepartmentIDDefault)) &&
        (this.fkiTimezoneID == null ? userRequestCompound.fkiTimezoneID == null : this.fkiTimezoneID.equals(userRequestCompound.fkiTimezoneID)) &&
        (this.fkiLanguageID == null ? userRequestCompound.fkiLanguageID == null : this.fkiLanguageID.equals(userRequestCompound.fkiLanguageID)) &&
        (this.objEmail == null ? userRequestCompound.objEmail == null : this.objEmail.equals(userRequestCompound.objEmail)) &&
        (this.fkiBillingentityinternalID == null ? userRequestCompound.fkiBillingentityinternalID == null : this.fkiBillingentityinternalID.equals(userRequestCompound.fkiBillingentityinternalID)) &&
        (this.objPhoneHome == null ? userRequestCompound.objPhoneHome == null : this.objPhoneHome.equals(userRequestCompound.objPhoneHome)) &&
        (this.objPhoneSMS == null ? userRequestCompound.objPhoneSMS == null : this.objPhoneSMS.equals(userRequestCompound.objPhoneSMS)) &&
        (this.fkiSecretquestionID == null ? userRequestCompound.fkiSecretquestionID == null : this.fkiSecretquestionID.equals(userRequestCompound.fkiSecretquestionID)) &&
        (this.sUserSecretresponse == null ? userRequestCompound.sUserSecretresponse == null : this.sUserSecretresponse.equals(userRequestCompound.sUserSecretresponse)) &&
        (this.fkiModuleIDForm == null ? userRequestCompound.fkiModuleIDForm == null : this.fkiModuleIDForm.equals(userRequestCompound.fkiModuleIDForm)) &&
        (this.eUserType == null ? userRequestCompound.eUserType == null : this.eUserType.equals(userRequestCompound.eUserType)) &&
        (this.eUserLogintype == null ? userRequestCompound.eUserLogintype == null : this.eUserLogintype.equals(userRequestCompound.eUserLogintype)) &&
        (this.sUserFirstname == null ? userRequestCompound.sUserFirstname == null : this.sUserFirstname.equals(userRequestCompound.sUserFirstname)) &&
        (this.sUserLastname == null ? userRequestCompound.sUserLastname == null : this.sUserLastname.equals(userRequestCompound.sUserLastname)) &&
        (this.sUserLoginname == null ? userRequestCompound.sUserLoginname == null : this.sUserLoginname.equals(userRequestCompound.sUserLoginname)) &&
        (this.sUserJobtitle == null ? userRequestCompound.sUserJobtitle == null : this.sUserJobtitle.equals(userRequestCompound.sUserJobtitle)) &&
        (this.eUserEzsignaccess == null ? userRequestCompound.eUserEzsignaccess == null : this.eUserEzsignaccess.equals(userRequestCompound.eUserEzsignaccess)) &&
        (this.bUserIsactive == null ? userRequestCompound.bUserIsactive == null : this.bUserIsactive.equals(userRequestCompound.bUserIsactive)) &&
        (this.bUserValidatebyadministration == null ? userRequestCompound.bUserValidatebyadministration == null : this.bUserValidatebyadministration.equals(userRequestCompound.bUserValidatebyadministration)) &&
        (this.bUserValidatebydirector == null ? userRequestCompound.bUserValidatebydirector == null : this.bUserValidatebydirector.equals(userRequestCompound.bUserValidatebydirector)) &&
        (this.bUserAttachmentautoverified == null ? userRequestCompound.bUserAttachmentautoverified == null : this.bUserAttachmentautoverified.equals(userRequestCompound.bUserAttachmentautoverified)) &&
        (this.bUserChangepassword == null ? userRequestCompound.bUserChangepassword == null : this.bUserChangepassword.equals(userRequestCompound.bUserChangepassword)) &&
        (this.bUserEzsigntemplaterolegrouping == null ? userRequestCompound.bUserEzsigntemplaterolegrouping == null : this.bUserEzsigntemplaterolegrouping.equals(userRequestCompound.bUserEzsigntemplaterolegrouping));
  }
