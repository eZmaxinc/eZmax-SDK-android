...
import org.openapitools.client.model.EzsignbulksendsignermappingResponseV3;
...
public class EzsignbulksendResponseCompoundV4 {
  ...
  private List<EzsignbulksenddocumentmappingResponseCompoundV3> aObjEzsignbulksenddocumentmapping = null;
  @SerializedName("a_objEzsignbulksendsignermapping")
  private List<EzsignbulksendsignermappingResponseV3> aObjEzsignbulksendsignermapping = null;
  ...
  public void setAObjEzsignbulksenddocumentmapping(List<EzsignbulksenddocumentmappingResponseCompoundV3> aObjEzsignbulksenddocumentmapping) {
  ...
  public void setAObjEzsignbulksendsignermapping(List<EzsignbulksendsignermappingResponseV3> aObjEzsignbulksendsignermapping) {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignbulksendID == null ? ezsignbulksendResponseCompoundV4.pkiEzsignbulksendID == null : this.pkiEzsignbulksendID.equals(ezsignbulksendResponseCompoundV4.pkiEzsignbulksendID)) &&
        (this.fkiEzsignfoldertypeID == null ? ezsignbulksendResponseCompoundV4.fkiEzsignfoldertypeID == null : this.fkiEzsignfoldertypeID.equals(ezsignbulksendResponseCompoundV4.fkiEzsignfoldertypeID)) &&
        (this.fkiLanguageID == null ? ezsignbulksendResponseCompoundV4.fkiLanguageID == null : this.fkiLanguageID.equals(ezsignbulksendResponseCompoundV4.fkiLanguageID)) &&
        (this.sLanguageNameX == null ? ezsignbulksendResponseCompoundV4.sLanguageNameX == null : this.sLanguageNameX.equals(ezsignbulksendResponseCompoundV4.sLanguageNameX)) &&
        (this.eEzsignbulksendEzsignformfieldorder == null ? ezsignbulksendResponseCompoundV4.eEzsignbulksendEzsignformfieldorder == null : this.eEzsignbulksendEzsignformfieldorder.equals(ezsignbulksendResponseCompoundV4.eEzsignbulksendEzsignformfieldorder)) &&
        (this.eEzsignfoldertypePrivacylevel == null ? ezsignbulksendResponseCompoundV4.eEzsignfoldertypePrivacylevel == null : this.eEzsignfoldertypePrivacylevel.equals(ezsignbulksendResponseCompoundV4.eEzsignfoldertypePrivacylevel)) &&
        (this.sEzsignfoldertypeNameX == null ? ezsignbulksendResponseCompoundV4.sEzsignfoldertypeNameX == null : this.sEzsignfoldertypeNameX.equals(ezsignbulksendResponseCompoundV4.sEzsignfoldertypeNameX)) &&
        (this.sEzsignbulksendDescription == null ? ezsignbulksendResponseCompoundV4.sEzsignbulksendDescription == null : this.sEzsignbulksendDescription.equals(ezsignbulksendResponseCompoundV4.sEzsignbulksendDescription)) &&
        (this.tEzsignbulksendNote == null ? ezsignbulksendResponseCompoundV4.tEzsignbulksendNote == null : this.tEzsignbulksendNote.equals(ezsignbulksendResponseCompoundV4.tEzsignbulksendNote)) &&
        (this.bEzsignbulksendNeedvalidation == null ? ezsignbulksendResponseCompoundV4.bEzsignbulksendNeedvalidation == null : this.bEzsignbulksendNeedvalidation.equals(ezsignbulksendResponseCompoundV4.bEzsignbulksendNeedvalidation)) &&
        (this.bEzsignbulksendIsactive == null ? ezsignbulksendResponseCompoundV4.bEzsignbulksendIsactive == null : this.bEzsignbulksendIsactive.equals(ezsignbulksendResponseCompoundV4.bEzsignbulksendIsactive)) &&
        (this.objAudit == null ? ezsignbulksendResponseCompoundV4.objAudit == null : this.objAudit.equals(ezsignbulksendResponseCompoundV4.objAudit)) &&
        (this.aObjEzsignbulksenddocumentmapping == null ? ezsignbulksendResponseCompoundV4.aObjEzsignbulksenddocumentmapping == null : this.aObjEzsignbulksenddocumentmapping.equals(ezsignbulksendResponseCompoundV4.aObjEzsignbulksenddocumentmapping)) &&
        (this.aObjEzsignbulksendsignermapping == null ? ezsignbulksendResponseCompoundV4.aObjEzsignbulksendsignermapping == null : this.aObjEzsignbulksendsignermapping.equals(ezsignbulksendResponseCompoundV4.aObjEzsignbulksendsignermapping));
  }
