...
public class CustomCreditcardtransactionResponse {
  ...
  @SerializedName("sCreditcardtypeCodename")
  private String sCreditcardtypeCodename = null;
   ...
   **/
  @ApiModelProperty(required = true, value = "The codename of the Creditcardtype")
  ...
  public boolean equals(Object o) {
    ...
    return (this.sCreditcardtypeCodename == null ? customCreditcardtransactionResponse.sCreditcardtypeCodename == null : this.sCreditcardtypeCodename.equals(customCreditcardtransactionResponse.sCreditcardtypeCodename)) &&
  ...
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.sCreditcardtypeCodename == null ? 0: this.sCreditcardtypeCodename.hashCode());
