...
public class EzsignbulksendRequestV2 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignbulksendID == null ? ezsignbulksendRequestV2.pkiEzsignbulksendID == null : this.pkiEzsignbulksendID.equals(ezsignbulksendRequestV2.pkiEzsignbulksendID)) &&
        (this.fkiEzsignfoldertypeID == null ? ezsignbulksendRequestV2.fkiEzsignfoldertypeID == null : this.fkiEzsignfoldertypeID.equals(ezsignbulksendRequestV2.fkiEzsignfoldertypeID)) &&
        (this.fkiLanguageID == null ? ezsignbulksendRequestV2.fkiLanguageID == null : this.fkiLanguageID.equals(ezsignbulksendRequestV2.fkiLanguageID)) &&
        (this.eEzsignbulksendEzsignformfieldorder == null ? ezsignbulksendRequestV2.eEzsignbulksendEzsignformfieldorder == null : this.eEzsignbulksendEzsignformfieldorder.equals(ezsignbulksendRequestV2.eEzsignbulksendEzsignformfieldorder)) &&
        (this.sEzsignbulksendDescription == null ? ezsignbulksendRequestV2.sEzsignbulksendDescription == null : this.sEzsignbulksendDescription.equals(ezsignbulksendRequestV2.sEzsignbulksendDescription)) &&
        (this.tEzsignbulksendNote == null ? ezsignbulksendRequestV2.tEzsignbulksendNote == null : this.tEzsignbulksendNote.equals(ezsignbulksendRequestV2.tEzsignbulksendNote)) &&
        (this.bEzsignbulksendNeedvalidation == null ? ezsignbulksendRequestV2.bEzsignbulksendNeedvalidation == null : this.bEzsignbulksendNeedvalidation.equals(ezsignbulksendRequestV2.bEzsignbulksendNeedvalidation)) &&
        (this.bEzsignbulksendIsactive == null ? ezsignbulksendRequestV2.bEzsignbulksendIsactive == null : this.bEzsignbulksendIsactive.equals(ezsignbulksendRequestV2.bEzsignbulksendIsactive));
  }
