...
public class EzsigntemplatedocumentpageResponseCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatedocumentpageID == null ? ezsigntemplatedocumentpageResponseCompound.pkiEzsigntemplatedocumentpageID == null : this.pkiEzsigntemplatedocumentpageID.equals(ezsigntemplatedocumentpageResponseCompound.pkiEzsigntemplatedocumentpageID)) &&
        (this.iEzsigntemplatedocumentpageWidthimage == null ? ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpageWidthimage == null : this.iEzsigntemplatedocumentpageWidthimage.equals(ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpageWidthimage)) &&
        (this.iEzsigntemplatedocumentpageHeightimage == null ? ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpageHeightimage == null : this.iEzsigntemplatedocumentpageHeightimage.equals(ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpageHeightimage)) &&
        (this.iEzsigntemplatedocumentpageWidthpdf == null ? ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpageWidthpdf == null : this.iEzsigntemplatedocumentpageWidthpdf.equals(ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpageWidthpdf)) &&
        (this.iEzsigntemplatedocumentpageHeightpdf == null ? ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpageHeightpdf == null : this.iEzsigntemplatedocumentpageHeightpdf.equals(ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpageHeightpdf)) &&
        (this.iEzsigntemplatedocumentpagePagenumber == null ? ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpagePagenumber == null : this.iEzsigntemplatedocumentpagePagenumber.equals(ezsigntemplatedocumentpageResponseCompound.iEzsigntemplatedocumentpagePagenumber)) &&
        (this.sComputedImageurl == null ? ezsigntemplatedocumentpageResponseCompound.sComputedImageurl == null : this.sComputedImageurl.equals(ezsigntemplatedocumentpageResponseCompound.sComputedImageurl));
  }
