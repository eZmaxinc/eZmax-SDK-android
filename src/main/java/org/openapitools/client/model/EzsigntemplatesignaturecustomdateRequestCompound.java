...
public class EzsigntemplatesignaturecustomdateRequestCompound {
   ...
   * minimum: 0
   **/
  @ApiModelProperty(value = "The unique ID of the Ezsigntemplatesignaturecustomdate")
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatesignaturecustomdateID == null ? ezsigntemplatesignaturecustomdateRequestCompound.pkiEzsigntemplatesignaturecustomdateID == null : this.pkiEzsigntemplatesignaturecustomdateID.equals(ezsigntemplatesignaturecustomdateRequestCompound.pkiEzsigntemplatesignaturecustomdateID)) &&
        (this.iEzsigntemplatesignaturecustomdateX == null ? ezsigntemplatesignaturecustomdateRequestCompound.iEzsigntemplatesignaturecustomdateX == null : this.iEzsigntemplatesignaturecustomdateX.equals(ezsigntemplatesignaturecustomdateRequestCompound.iEzsigntemplatesignaturecustomdateX)) &&
        (this.iEzsigntemplatesignaturecustomdateY == null ? ezsigntemplatesignaturecustomdateRequestCompound.iEzsigntemplatesignaturecustomdateY == null : this.iEzsigntemplatesignaturecustomdateY.equals(ezsigntemplatesignaturecustomdateRequestCompound.iEzsigntemplatesignaturecustomdateY)) &&
        (this.iEzsigntemplatesignaturecustomdateOffsetx == null ? ezsigntemplatesignaturecustomdateRequestCompound.iEzsigntemplatesignaturecustomdateOffsetx == null : this.iEzsigntemplatesignaturecustomdateOffsetx.equals(ezsigntemplatesignaturecustomdateRequestCompound.iEzsigntemplatesignaturecustomdateOffsetx)) &&
        (this.iEzsigntemplatesignaturecustomdateOffsety == null ? ezsigntemplatesignaturecustomdateRequestCompound.iEzsigntemplatesignaturecustomdateOffsety == null : this.iEzsigntemplatesignaturecustomdateOffsety.equals(ezsigntemplatesignaturecustomdateRequestCompound.iEzsigntemplatesignaturecustomdateOffsety)) &&
        (this.sEzsigntemplatesignaturecustomdateFormat == null ? ezsigntemplatesignaturecustomdateRequestCompound.sEzsigntemplatesignaturecustomdateFormat == null : this.sEzsigntemplatesignaturecustomdateFormat.equals(ezsigntemplatesignaturecustomdateRequestCompound.sEzsigntemplatesignaturecustomdateFormat));
  }
