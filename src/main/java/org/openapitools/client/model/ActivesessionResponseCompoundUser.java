...
public class ActivesessionResponseCompoundUser {
  ...
  @SerializedName("bUserAddmeinezsignfolder")
  private Boolean bUserAddmeinezsignfolder = null;
  ...
  @SerializedName("iUserFrontendgoal")
  private Integer iUserFrontendgoal = null;
   ...
   **/
  @ApiModelProperty(required = true, value = "Whether if I want to automatically add myself during the creation of Ezsignfolder of which I am the owner")
  public Boolean getBUserAddmeinezsignfolder() {
    return bUserAddmeinezsignfolder;
  }
  public void setBUserAddmeinezsignfolder(Boolean bUserAddmeinezsignfolder) {
   ...
   * minimum: 0
   **/
  @ApiModelProperty(required = true, value = "Goals save as bit wise (one bit per goal)")
  public Integer getIUserFrontendgoal() {
    return iUserFrontendgoal;
  }
  public void setIUserFrontendgoal(Integer iUserFrontendgoal) {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiUserID == null ? activesessionResponseCompoundUser.pkiUserID == null : this.pkiUserID.equals(activesessionResponseCompoundUser.pkiUserID)) &&
        ...
        (this.bUserAddmeinezsignfolder == null ? activesessionResponseCompoundUser.bUserAddmeinezsignfolder == null : this.bUserAddmeinezsignfolder.equals(activesessionResponseCompoundUser.bUserAddmeinezsignfolder)) &&
        ...
        (this.iUserFrontendgoal == null ? activesessionResponseCompoundUser.iUserFrontendgoal == null : this.iUserFrontendgoal.equals(activesessionResponseCompoundUser.iUserFrontendgoal));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.bUserAddmeinezsignfolder == null ? 0: this.bUserAddmeinezsignfolder.hashCode());
    ...
    result = 31 * result + (this.iUserFrontendgoal == null ? 0: this.iUserFrontendgoal.hashCode());
    return result;
  }
