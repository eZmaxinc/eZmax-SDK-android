...
public class EzsignelementdependencyResponseCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignelementdependencyID == null ? ezsignelementdependencyResponseCompound.pkiEzsignelementdependencyID == null : this.pkiEzsignelementdependencyID.equals(ezsignelementdependencyResponseCompound.pkiEzsignelementdependencyID)) &&
        (this.fkiEzsignformfieldID == null ? ezsignelementdependencyResponseCompound.fkiEzsignformfieldID == null : this.fkiEzsignformfieldID.equals(ezsignelementdependencyResponseCompound.fkiEzsignformfieldID)) &&
        (this.fkiEzsignsignatureID == null ? ezsignelementdependencyResponseCompound.fkiEzsignsignatureID == null : this.fkiEzsignsignatureID.equals(ezsignelementdependencyResponseCompound.fkiEzsignsignatureID)) &&
        (this.fkiEzsignformfieldIDValidation == null ? ezsignelementdependencyResponseCompound.fkiEzsignformfieldIDValidation == null : this.fkiEzsignformfieldIDValidation.equals(ezsignelementdependencyResponseCompound.fkiEzsignformfieldIDValidation)) &&
        (this.fkiEzsignformfieldgroupIDValidation == null ? ezsignelementdependencyResponseCompound.fkiEzsignformfieldgroupIDValidation == null : this.fkiEzsignformfieldgroupIDValidation.equals(ezsignelementdependencyResponseCompound.fkiEzsignformfieldgroupIDValidation)) &&
        (this.eEzsignelementdependencyValidation == null ? ezsignelementdependencyResponseCompound.eEzsignelementdependencyValidation == null : this.eEzsignelementdependencyValidation.equals(ezsignelementdependencyResponseCompound.eEzsignelementdependencyValidation)) &&
        (this.bEzsignelementdependencySelected == null ? ezsignelementdependencyResponseCompound.bEzsignelementdependencySelected == null : this.bEzsignelementdependencySelected.equals(ezsignelementdependencyResponseCompound.bEzsignelementdependencySelected)) &&
        (this.eEzsignelementdependencyOperator == null ? ezsignelementdependencyResponseCompound.eEzsignelementdependencyOperator == null : this.eEzsignelementdependencyOperator.equals(ezsignelementdependencyResponseCompound.eEzsignelementdependencyOperator)) &&
        (this.sEzsignelementdependencyValue == null ? ezsignelementdependencyResponseCompound.sEzsignelementdependencyValue == null : this.sEzsignelementdependencyValue.equals(ezsignelementdependencyResponseCompound.sEzsignelementdependencyValue));
  }
