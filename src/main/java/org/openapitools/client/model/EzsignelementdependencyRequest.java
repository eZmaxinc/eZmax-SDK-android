...
public class EzsignelementdependencyRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignelementdependencyID == null ? ezsignelementdependencyRequest.pkiEzsignelementdependencyID == null : this.pkiEzsignelementdependencyID.equals(ezsignelementdependencyRequest.pkiEzsignelementdependencyID)) &&
        (this.fkiEzsignformfieldIDValidation == null ? ezsignelementdependencyRequest.fkiEzsignformfieldIDValidation == null : this.fkiEzsignformfieldIDValidation.equals(ezsignelementdependencyRequest.fkiEzsignformfieldIDValidation)) &&
        (this.fkiEzsignformfieldgroupIDValidation == null ? ezsignelementdependencyRequest.fkiEzsignformfieldgroupIDValidation == null : this.fkiEzsignformfieldgroupIDValidation.equals(ezsignelementdependencyRequest.fkiEzsignformfieldgroupIDValidation)) &&
        (this.sEzsignelementdependencyEzsignformfieldgrouplabel == null ? ezsignelementdependencyRequest.sEzsignelementdependencyEzsignformfieldgrouplabel == null : this.sEzsignelementdependencyEzsignformfieldgrouplabel.equals(ezsignelementdependencyRequest.sEzsignelementdependencyEzsignformfieldgrouplabel)) &&
        (this.sEzsignelementdependencyEzsignformfieldlabel == null ? ezsignelementdependencyRequest.sEzsignelementdependencyEzsignformfieldlabel == null : this.sEzsignelementdependencyEzsignformfieldlabel.equals(ezsignelementdependencyRequest.sEzsignelementdependencyEzsignformfieldlabel)) &&
        (this.eEzsignelementdependencyValidation == null ? ezsignelementdependencyRequest.eEzsignelementdependencyValidation == null : this.eEzsignelementdependencyValidation.equals(ezsignelementdependencyRequest.eEzsignelementdependencyValidation)) &&
        (this.bEzsignelementdependencySelected == null ? ezsignelementdependencyRequest.bEzsignelementdependencySelected == null : this.bEzsignelementdependencySelected.equals(ezsignelementdependencyRequest.bEzsignelementdependencySelected)) &&
        (this.eEzsignelementdependencyOperator == null ? ezsignelementdependencyRequest.eEzsignelementdependencyOperator == null : this.eEzsignelementdependencyOperator.equals(ezsignelementdependencyRequest.eEzsignelementdependencyOperator)) &&
        (this.sEzsignelementdependencyValue == null ? ezsignelementdependencyRequest.sEzsignelementdependencyValue == null : this.sEzsignelementdependencyValue.equals(ezsignelementdependencyRequest.sEzsignelementdependencyValue));
  }
