 ...
 **/
@ApiModel(description = "A Creditcardmerchant Object and children")
public class CreditcardmerchantRequestCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiCreditcardmerchantID == null ? creditcardmerchantRequestCompound.pkiCreditcardmerchantID == null : this.pkiCreditcardmerchantID.equals(creditcardmerchantRequestCompound.pkiCreditcardmerchantID)) &&
        (this.fkiBankaccountID == null ? creditcardmerchantRequestCompound.fkiBankaccountID == null : this.fkiBankaccountID.equals(creditcardmerchantRequestCompound.fkiBankaccountID)) &&
        (this.fkiLanguageID == null ? creditcardmerchantRequestCompound.fkiLanguageID == null : this.fkiLanguageID.equals(creditcardmerchantRequestCompound.fkiLanguageID)) &&
        (this.fkiCurrencyID == null ? creditcardmerchantRequestCompound.fkiCurrencyID == null : this.fkiCurrencyID.equals(creditcardmerchantRequestCompound.fkiCurrencyID)) &&
        (this.bCreditcardmerchantDenyvisa == null ? creditcardmerchantRequestCompound.bCreditcardmerchantDenyvisa == null : this.bCreditcardmerchantDenyvisa.equals(creditcardmerchantRequestCompound.bCreditcardmerchantDenyvisa)) &&
        (this.bCreditcardmerchantDenymastercard == null ? creditcardmerchantRequestCompound.bCreditcardmerchantDenymastercard == null : this.bCreditcardmerchantDenymastercard.equals(creditcardmerchantRequestCompound.bCreditcardmerchantDenymastercard)) &&
        (this.bCreditcardmerchantDenyamex == null ? creditcardmerchantRequestCompound.bCreditcardmerchantDenyamex == null : this.bCreditcardmerchantDenyamex.equals(creditcardmerchantRequestCompound.bCreditcardmerchantDenyamex)) &&
        (this.bCreditcardmerchantIsactive == null ? creditcardmerchantRequestCompound.bCreditcardmerchantIsactive == null : this.bCreditcardmerchantIsactive.equals(creditcardmerchantRequestCompound.bCreditcardmerchantIsactive)) &&
        (this.sCreditcardmerchantApitoken == null ? creditcardmerchantRequestCompound.sCreditcardmerchantApitoken == null : this.sCreditcardmerchantApitoken.equals(creditcardmerchantRequestCompound.sCreditcardmerchantApitoken)) &&
        (this.sCreditcardmerchantDescription == null ? creditcardmerchantRequestCompound.sCreditcardmerchantDescription == null : this.sCreditcardmerchantDescription.equals(creditcardmerchantRequestCompound.sCreditcardmerchantDescription)) &&
        (this.sCreditcardmerchantStoreid == null ? creditcardmerchantRequestCompound.sCreditcardmerchantStoreid == null : this.sCreditcardmerchantStoreid.equals(creditcardmerchantRequestCompound.sCreditcardmerchantStoreid));
  }
