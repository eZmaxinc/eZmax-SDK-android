...
public class UserRequestV2 {
  ...
  private PhoneRequestCompoundV2 objPhoneHome = null;
  @SerializedName("objPhoneSMS")
  private PhoneRequestCompoundV2 objPhoneSMS = null;
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiUserID == null ? userRequestV2.pkiUserID == null : this.pkiUserID.equals(userRequestV2.pkiUserID)) &&
        (this.fkiAgentID == null ? userRequestV2.fkiAgentID == null : this.fkiAgentID.equals(userRequestV2.fkiAgentID)) &&
        (this.fkiBrokerID == null ? userRequestV2.fkiBrokerID == null : this.fkiBrokerID.equals(userRequestV2.fkiBrokerID)) &&
        (this.fkiAssistantID == null ? userRequestV2.fkiAssistantID == null : this.fkiAssistantID.equals(userRequestV2.fkiAssistantID)) &&
        (this.fkiEmployeeID == null ? userRequestV2.fkiEmployeeID == null : this.fkiEmployeeID.equals(userRequestV2.fkiEmployeeID)) &&
        (this.fkiCompanyIDDefault == null ? userRequestV2.fkiCompanyIDDefault == null : this.fkiCompanyIDDefault.equals(userRequestV2.fkiCompanyIDDefault)) &&
        (this.fkiDepartmentIDDefault == null ? userRequestV2.fkiDepartmentIDDefault == null : this.fkiDepartmentIDDefault.equals(userRequestV2.fkiDepartmentIDDefault)) &&
        (this.fkiTimezoneID == null ? userRequestV2.fkiTimezoneID == null : this.fkiTimezoneID.equals(userRequestV2.fkiTimezoneID)) &&
        (this.fkiLanguageID == null ? userRequestV2.fkiLanguageID == null : this.fkiLanguageID.equals(userRequestV2.fkiLanguageID)) &&
        (this.objEmail == null ? userRequestV2.objEmail == null : this.objEmail.equals(userRequestV2.objEmail)) &&
        (this.fkiBillingentityinternalID == null ? userRequestV2.fkiBillingentityinternalID == null : this.fkiBillingentityinternalID.equals(userRequestV2.fkiBillingentityinternalID)) &&
        (this.objPhoneHome == null ? userRequestV2.objPhoneHome == null : this.objPhoneHome.equals(userRequestV2.objPhoneHome)) &&
        (this.objPhoneSMS == null ? userRequestV2.objPhoneSMS == null : this.objPhoneSMS.equals(userRequestV2.objPhoneSMS)) &&
        (this.fkiSecretquestionID == null ? userRequestV2.fkiSecretquestionID == null : this.fkiSecretquestionID.equals(userRequestV2.fkiSecretquestionID)) &&
        (this.sUserSecretresponse == null ? userRequestV2.sUserSecretresponse == null : this.sUserSecretresponse.equals(userRequestV2.sUserSecretresponse)) &&
        (this.fkiModuleIDForm == null ? userRequestV2.fkiModuleIDForm == null : this.fkiModuleIDForm.equals(userRequestV2.fkiModuleIDForm)) &&
        (this.eUserType == null ? userRequestV2.eUserType == null : this.eUserType.equals(userRequestV2.eUserType)) &&
        (this.eUserLogintype == null ? userRequestV2.eUserLogintype == null : this.eUserLogintype.equals(userRequestV2.eUserLogintype)) &&
        (this.sUserFirstname == null ? userRequestV2.sUserFirstname == null : this.sUserFirstname.equals(userRequestV2.sUserFirstname)) &&
        (this.sUserLastname == null ? userRequestV2.sUserLastname == null : this.sUserLastname.equals(userRequestV2.sUserLastname)) &&
        (this.sUserLoginname == null ? userRequestV2.sUserLoginname == null : this.sUserLoginname.equals(userRequestV2.sUserLoginname)) &&
        (this.sUserJobtitle == null ? userRequestV2.sUserJobtitle == null : this.sUserJobtitle.equals(userRequestV2.sUserJobtitle)) &&
        (this.eUserEzsignaccess == null ? userRequestV2.eUserEzsignaccess == null : this.eUserEzsignaccess.equals(userRequestV2.eUserEzsignaccess)) &&
        (this.bUserIsactive == null ? userRequestV2.bUserIsactive == null : this.bUserIsactive.equals(userRequestV2.bUserIsactive)) &&
        (this.bUserValidatebyadministration == null ? userRequestV2.bUserValidatebyadministration == null : this.bUserValidatebyadministration.equals(userRequestV2.bUserValidatebyadministration)) &&
        (this.bUserValidatebydirector == null ? userRequestV2.bUserValidatebydirector == null : this.bUserValidatebydirector.equals(userRequestV2.bUserValidatebydirector)) &&
        (this.bUserAttachmentautoverified == null ? userRequestV2.bUserAttachmentautoverified == null : this.bUserAttachmentautoverified.equals(userRequestV2.bUserAttachmentautoverified)) &&
        (this.bUserChangepassword == null ? userRequestV2.bUserChangepassword == null : this.bUserChangepassword.equals(userRequestV2.bUserChangepassword)) &&
        (this.bUserEzsigntemplaterolegrouping == null ? userRequestV2.bUserEzsigntemplaterolegrouping == null : this.bUserEzsigntemplaterolegrouping.equals(userRequestV2.bUserEzsigntemplaterolegrouping));
  }
