...
public class SubnetResponseCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiSubnetID == null ? subnetResponseCompound.pkiSubnetID == null : this.pkiSubnetID.equals(subnetResponseCompound.pkiSubnetID)) &&
        (this.fkiUserID == null ? subnetResponseCompound.fkiUserID == null : this.fkiUserID.equals(subnetResponseCompound.fkiUserID)) &&
        (this.fkiApikeyID == null ? subnetResponseCompound.fkiApikeyID == null : this.fkiApikeyID.equals(subnetResponseCompound.fkiApikeyID)) &&
        (this.objSubnetDescription == null ? subnetResponseCompound.objSubnetDescription == null : this.objSubnetDescription.equals(subnetResponseCompound.objSubnetDescription)) &&
        (this.iSubnetNetwork == null ? subnetResponseCompound.iSubnetNetwork == null : this.iSubnetNetwork.equals(subnetResponseCompound.iSubnetNetwork)) &&
        (this.iSubnetMask == null ? subnetResponseCompound.iSubnetMask == null : this.iSubnetMask.equals(subnetResponseCompound.iSubnetMask));
  }
