...
public class EzsignannotationResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignannotationID == null ? ezsignannotationResponse.pkiEzsignannotationID == null : this.pkiEzsignannotationID.equals(ezsignannotationResponse.pkiEzsignannotationID)) &&
        (this.fkiEzsigndocumentID == null ? ezsignannotationResponse.fkiEzsigndocumentID == null : this.fkiEzsigndocumentID.equals(ezsignannotationResponse.fkiEzsigndocumentID)) &&
        (this.eEzsignannotationHorizontalalignment == null ? ezsignannotationResponse.eEzsignannotationHorizontalalignment == null : this.eEzsignannotationHorizontalalignment.equals(ezsignannotationResponse.eEzsignannotationHorizontalalignment)) &&
        (this.eEzsignannotationVerticalalignment == null ? ezsignannotationResponse.eEzsignannotationVerticalalignment == null : this.eEzsignannotationVerticalalignment.equals(ezsignannotationResponse.eEzsignannotationVerticalalignment)) &&
        (this.eEzsignannotationType == null ? ezsignannotationResponse.eEzsignannotationType == null : this.eEzsignannotationType.equals(ezsignannotationResponse.eEzsignannotationType)) &&
        (this.iEzsignannotationX == null ? ezsignannotationResponse.iEzsignannotationX == null : this.iEzsignannotationX.equals(ezsignannotationResponse.iEzsignannotationX)) &&
        (this.iEzsignannotationY == null ? ezsignannotationResponse.iEzsignannotationY == null : this.iEzsignannotationY.equals(ezsignannotationResponse.iEzsignannotationY)) &&
        (this.iEzsignannotationWidth == null ? ezsignannotationResponse.iEzsignannotationWidth == null : this.iEzsignannotationWidth.equals(ezsignannotationResponse.iEzsignannotationWidth)) &&
        (this.iEzsignannotationHeight == null ? ezsignannotationResponse.iEzsignannotationHeight == null : this.iEzsignannotationHeight.equals(ezsignannotationResponse.iEzsignannotationHeight)) &&
        (this.sEzsignannotationText == null ? ezsignannotationResponse.sEzsignannotationText == null : this.sEzsignannotationText.equals(ezsignannotationResponse.sEzsignannotationText)) &&
        (this.iEzsignpagePagenumber == null ? ezsignannotationResponse.iEzsignpagePagenumber == null : this.iEzsignpagePagenumber.equals(ezsignannotationResponse.iEzsignpagePagenumber));
  }
