 ...
 **/
@ApiModel(description = "A Communicationreference Object and children")
public class CommunicationreferenceRequestCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiCommunicationreferenceID == null ? communicationreferenceRequestCompound.pkiCommunicationreferenceID == null : this.pkiCommunicationreferenceID.equals(communicationreferenceRequestCompound.pkiCommunicationreferenceID)) &&
        (this.fkiBuyercontractID == null ? communicationreferenceRequestCompound.fkiBuyercontractID == null : this.fkiBuyercontractID.equals(communicationreferenceRequestCompound.fkiBuyercontractID)) &&
        (this.fkiEzsignfolderID == null ? communicationreferenceRequestCompound.fkiEzsignfolderID == null : this.fkiEzsignfolderID.equals(communicationreferenceRequestCompound.fkiEzsignfolderID)) &&
        (this.fkiInscriptionID == null ? communicationreferenceRequestCompound.fkiInscriptionID == null : this.fkiInscriptionID.equals(communicationreferenceRequestCompound.fkiInscriptionID)) &&
        (this.fkiInscriptiontempID == null ? communicationreferenceRequestCompound.fkiInscriptiontempID == null : this.fkiInscriptiontempID.equals(communicationreferenceRequestCompound.fkiInscriptiontempID)) &&
        (this.fkiInvoiceID == null ? communicationreferenceRequestCompound.fkiInvoiceID == null : this.fkiInvoiceID.equals(communicationreferenceRequestCompound.fkiInvoiceID)) &&
        (this.fkiOtherincomeID == null ? communicationreferenceRequestCompound.fkiOtherincomeID == null : this.fkiOtherincomeID.equals(communicationreferenceRequestCompound.fkiOtherincomeID)) &&
        (this.fkiElectronicfundstransferID == null ? communicationreferenceRequestCompound.fkiElectronicfundstransferID == null : this.fkiElectronicfundstransferID.equals(communicationreferenceRequestCompound.fkiElectronicfundstransferID)) &&
        (this.fkiRejectedoffertopurchaseID == null ? communicationreferenceRequestCompound.fkiRejectedoffertopurchaseID == null : this.fkiRejectedoffertopurchaseID.equals(communicationreferenceRequestCompound.fkiRejectedoffertopurchaseID));
  }
