...
public class EzsigntemplateResponseV4 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplateID == null ? ezsigntemplateResponseV4.pkiEzsigntemplateID == null : this.pkiEzsigntemplateID.equals(ezsigntemplateResponseV4.pkiEzsigntemplateID)) &&
        (this.fkiEzsigntemplatedocumentID == null ? ezsigntemplateResponseV4.fkiEzsigntemplatedocumentID == null : this.fkiEzsigntemplatedocumentID.equals(ezsigntemplateResponseV4.fkiEzsigntemplatedocumentID)) &&
        (this.fkiEzsignfoldertypeID == null ? ezsigntemplateResponseV4.fkiEzsignfoldertypeID == null : this.fkiEzsignfoldertypeID.equals(ezsigntemplateResponseV4.fkiEzsignfoldertypeID)) &&
        (this.objEzsignfoldertype == null ? ezsigntemplateResponseV4.objEzsignfoldertype == null : this.objEzsignfoldertype.equals(ezsigntemplateResponseV4.objEzsignfoldertype)) &&
        (this.fkiLanguageID == null ? ezsigntemplateResponseV4.fkiLanguageID == null : this.fkiLanguageID.equals(ezsigntemplateResponseV4.fkiLanguageID)) &&
        (this.fkiEzdoctemplatedocumentID == null ? ezsigntemplateResponseV4.fkiEzdoctemplatedocumentID == null : this.fkiEzdoctemplatedocumentID.equals(ezsigntemplateResponseV4.fkiEzdoctemplatedocumentID)) &&
        (this.sEzdoctemplatedocumentNameX == null ? ezsigntemplateResponseV4.sEzdoctemplatedocumentNameX == null : this.sEzdoctemplatedocumentNameX.equals(ezsigntemplateResponseV4.sEzdoctemplatedocumentNameX)) &&
        (this.sLanguageNameX == null ? ezsigntemplateResponseV4.sLanguageNameX == null : this.sLanguageNameX.equals(ezsigntemplateResponseV4.sLanguageNameX)) &&
        (this.sEzsigntemplateDescription == null ? ezsigntemplateResponseV4.sEzsigntemplateDescription == null : this.sEzsigntemplateDescription.equals(ezsigntemplateResponseV4.sEzsigntemplateDescription)) &&
        (this.sEzsigntemplateExternaldescription == null ? ezsigntemplateResponseV4.sEzsigntemplateExternaldescription == null : this.sEzsigntemplateExternaldescription.equals(ezsigntemplateResponseV4.sEzsigntemplateExternaldescription)) &&
        (this.tEzsigntemplateComment == null ? ezsigntemplateResponseV4.tEzsigntemplateComment == null : this.tEzsigntemplateComment.equals(ezsigntemplateResponseV4.tEzsigntemplateComment)) &&
        (this.eEzsigntemplateRecognition == null ? ezsigntemplateResponseV4.eEzsigntemplateRecognition == null : this.eEzsigntemplateRecognition.equals(ezsigntemplateResponseV4.eEzsigntemplateRecognition)) &&
        (this.sEzsigntemplateFilenameregexp == null ? ezsigntemplateResponseV4.sEzsigntemplateFilenameregexp == null : this.sEzsigntemplateFilenameregexp.equals(ezsigntemplateResponseV4.sEzsigntemplateFilenameregexp)) &&
        (this.bEzsigntemplateAdminonly == null ? ezsigntemplateResponseV4.bEzsigntemplateAdminonly == null : this.bEzsigntemplateAdminonly.equals(ezsigntemplateResponseV4.bEzsigntemplateAdminonly)) &&
        (this.sEzsignfoldertypeNameX == null ? ezsigntemplateResponseV4.sEzsignfoldertypeNameX == null : this.sEzsignfoldertypeNameX.equals(ezsigntemplateResponseV4.sEzsignfoldertypeNameX)) &&
        (this.objAudit == null ? ezsigntemplateResponseV4.objAudit == null : this.objAudit.equals(ezsigntemplateResponseV4.objAudit)) &&
        (this.bEzsigntemplateEditallowed == null ? ezsigntemplateResponseV4.bEzsigntemplateEditallowed == null : this.bEzsigntemplateEditallowed.equals(ezsigntemplateResponseV4.bEzsigntemplateEditallowed)) &&
        (this.eEzsigntemplateType == null ? ezsigntemplateResponseV4.eEzsigntemplateType == null : this.eEzsigntemplateType.equals(ezsigntemplateResponseV4.eEzsigntemplateType));
  }
