...
public class EzsigntemplatesignerRequestV2 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatesignerID == null ? ezsigntemplatesignerRequestV2.pkiEzsigntemplatesignerID == null : this.pkiEzsigntemplatesignerID.equals(ezsigntemplatesignerRequestV2.pkiEzsigntemplatesignerID)) &&
        (this.fkiEzsigntemplateID == null ? ezsigntemplatesignerRequestV2.fkiEzsigntemplateID == null : this.fkiEzsigntemplateID.equals(ezsigntemplatesignerRequestV2.fkiEzsigntemplateID)) &&
        (this.fkiUserID == null ? ezsigntemplatesignerRequestV2.fkiUserID == null : this.fkiUserID.equals(ezsigntemplatesignerRequestV2.fkiUserID)) &&
        (this.fkiUsergroupID == null ? ezsigntemplatesignerRequestV2.fkiUsergroupID == null : this.fkiUsergroupID.equals(ezsigntemplatesignerRequestV2.fkiUsergroupID)) &&
        (this.fkiEzdoctemplatedocumentID == null ? ezsigntemplatesignerRequestV2.fkiEzdoctemplatedocumentID == null : this.fkiEzdoctemplatedocumentID.equals(ezsigntemplatesignerRequestV2.fkiEzdoctemplatedocumentID)) &&
        (this.eEzsigntemplatesignerRole == null ? ezsigntemplatesignerRequestV2.eEzsigntemplatesignerRole == null : this.eEzsigntemplatesignerRole.equals(ezsigntemplatesignerRequestV2.eEzsigntemplatesignerRole)) &&
        (this.eEzsigntemplatesignerMapping == null ? ezsigntemplatesignerRequestV2.eEzsigntemplatesignerMapping == null : this.eEzsigntemplatesignerMapping.equals(ezsigntemplatesignerRequestV2.eEzsigntemplatesignerMapping)) &&
        (this.sEzsigntemplatesignerDescription == null ? ezsigntemplatesignerRequestV2.sEzsigntemplatesignerDescription == null : this.sEzsigntemplatesignerDescription.equals(ezsigntemplatesignerRequestV2.sEzsigntemplatesignerDescription));
  }
