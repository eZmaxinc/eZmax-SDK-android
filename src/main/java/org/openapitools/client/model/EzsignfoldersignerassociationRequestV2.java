...
public class EzsignfoldersignerassociationRequestV2 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignfoldersignerassociationID == null ? ezsignfoldersignerassociationRequestV2.pkiEzsignfoldersignerassociationID == null : this.pkiEzsignfoldersignerassociationID.equals(ezsignfoldersignerassociationRequestV2.pkiEzsignfoldersignerassociationID)) &&
        (this.fkiUserID == null ? ezsignfoldersignerassociationRequestV2.fkiUserID == null : this.fkiUserID.equals(ezsignfoldersignerassociationRequestV2.fkiUserID)) &&
        (this.fkiEzsignsignergroupID == null ? ezsignfoldersignerassociationRequestV2.fkiEzsignsignergroupID == null : this.fkiEzsignsignergroupID.equals(ezsignfoldersignerassociationRequestV2.fkiEzsignsignergroupID)) &&
        (this.fkiEzsignfolderID == null ? ezsignfoldersignerassociationRequestV2.fkiEzsignfolderID == null : this.fkiEzsignfolderID.equals(ezsignfoldersignerassociationRequestV2.fkiEzsignfolderID)) &&
        (this.eEzsignfoldersignerassociationRole == null ? ezsignfoldersignerassociationRequestV2.eEzsignfoldersignerassociationRole == null : this.eEzsignfoldersignerassociationRole.equals(ezsignfoldersignerassociationRequestV2.eEzsignfoldersignerassociationRole)) &&
        (this.tEzsignfoldersignerassociationMessage == null ? ezsignfoldersignerassociationRequestV2.tEzsignfoldersignerassociationMessage == null : this.tEzsignfoldersignerassociationMessage.equals(ezsignfoldersignerassociationRequestV2.tEzsignfoldersignerassociationMessage));
  }
