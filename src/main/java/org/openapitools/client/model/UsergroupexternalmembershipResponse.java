...
public class UsergroupexternalmembershipResponse {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiUsergroupexternalmembershipID == null ? usergroupexternalmembershipResponse.pkiUsergroupexternalmembershipID == null : this.pkiUsergroupexternalmembershipID.equals(usergroupexternalmembershipResponse.pkiUsergroupexternalmembershipID)) &&
        (this.fkiUsergroupexternalID == null ? usergroupexternalmembershipResponse.fkiUsergroupexternalID == null : this.fkiUsergroupexternalID.equals(usergroupexternalmembershipResponse.fkiUsergroupexternalID)) &&
        (this.fkiUserID == null ? usergroupexternalmembershipResponse.fkiUserID == null : this.fkiUserID.equals(usergroupexternalmembershipResponse.fkiUserID)) &&
        (this.sUserFirstname == null ? usergroupexternalmembershipResponse.sUserFirstname == null : this.sUserFirstname.equals(usergroupexternalmembershipResponse.sUserFirstname)) &&
        (this.sUserLastname == null ? usergroupexternalmembershipResponse.sUserLastname == null : this.sUserLastname.equals(usergroupexternalmembershipResponse.sUserLastname)) &&
        (this.sUserLoginname == null ? usergroupexternalmembershipResponse.sUserLoginname == null : this.sUserLoginname.equals(usergroupexternalmembershipResponse.sUserLoginname)) &&
        (this.sEmailAddress == null ? usergroupexternalmembershipResponse.sEmailAddress == null : this.sEmailAddress.equals(usergroupexternalmembershipResponse.sEmailAddress)) &&
        (this.sUsergroupexternalName == null ? usergroupexternalmembershipResponse.sUsergroupexternalName == null : this.sUsergroupexternalName.equals(usergroupexternalmembershipResponse.sUsergroupexternalName));
  }
