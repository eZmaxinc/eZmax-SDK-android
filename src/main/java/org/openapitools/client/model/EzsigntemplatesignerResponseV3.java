...
public class EzsigntemplatesignerResponseV3 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatesignerID == null ? ezsigntemplatesignerResponseV3.pkiEzsigntemplatesignerID == null : this.pkiEzsigntemplatesignerID.equals(ezsigntemplatesignerResponseV3.pkiEzsigntemplatesignerID)) &&
        (this.fkiEzsigntemplateID == null ? ezsigntemplatesignerResponseV3.fkiEzsigntemplateID == null : this.fkiEzsigntemplateID.equals(ezsigntemplatesignerResponseV3.fkiEzsigntemplateID)) &&
        (this.fkiUserID == null ? ezsigntemplatesignerResponseV3.fkiUserID == null : this.fkiUserID.equals(ezsigntemplatesignerResponseV3.fkiUserID)) &&
        (this.fkiUsergroupID == null ? ezsigntemplatesignerResponseV3.fkiUsergroupID == null : this.fkiUsergroupID.equals(ezsigntemplatesignerResponseV3.fkiUsergroupID)) &&
        (this.fkiEzdoctemplatedocumentID == null ? ezsigntemplatesignerResponseV3.fkiEzdoctemplatedocumentID == null : this.fkiEzdoctemplatedocumentID.equals(ezsigntemplatesignerResponseV3.fkiEzdoctemplatedocumentID)) &&
        (this.eEzsigntemplatesignerRole == null ? ezsigntemplatesignerResponseV3.eEzsigntemplatesignerRole == null : this.eEzsigntemplatesignerRole.equals(ezsigntemplatesignerResponseV3.eEzsigntemplatesignerRole)) &&
        (this.eEzsigntemplatesignerMapping == null ? ezsigntemplatesignerResponseV3.eEzsigntemplatesignerMapping == null : this.eEzsigntemplatesignerMapping.equals(ezsigntemplatesignerResponseV3.eEzsigntemplatesignerMapping)) &&
        (this.sEzsigntemplatesignerDescription == null ? ezsigntemplatesignerResponseV3.sEzsigntemplatesignerDescription == null : this.sEzsigntemplatesignerDescription.equals(ezsigntemplatesignerResponseV3.sEzsigntemplatesignerDescription)) &&
        (this.sUserName == null ? ezsigntemplatesignerResponseV3.sUserName == null : this.sUserName.equals(ezsigntemplatesignerResponseV3.sUserName)) &&
        (this.sUsergroupNameX == null ? ezsigntemplatesignerResponseV3.sUsergroupNameX == null : this.sUsergroupNameX.equals(ezsigntemplatesignerResponseV3.sUsergroupNameX));
  }
