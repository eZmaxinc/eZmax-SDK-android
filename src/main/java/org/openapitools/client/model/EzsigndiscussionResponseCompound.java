...
public class EzsigndiscussionResponseCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigndiscussionID == null ? ezsigndiscussionResponseCompound.pkiEzsigndiscussionID == null : this.pkiEzsigndiscussionID.equals(ezsigndiscussionResponseCompound.pkiEzsigndiscussionID)) &&
        (this.fkiEzsignpageID == null ? ezsigndiscussionResponseCompound.fkiEzsignpageID == null : this.fkiEzsignpageID.equals(ezsigndiscussionResponseCompound.fkiEzsignpageID)) &&
        (this.fkiDiscussionID == null ? ezsigndiscussionResponseCompound.fkiDiscussionID == null : this.fkiDiscussionID.equals(ezsigndiscussionResponseCompound.fkiDiscussionID)) &&
        (this.iEzsigndiscussionX == null ? ezsigndiscussionResponseCompound.iEzsigndiscussionX == null : this.iEzsigndiscussionX.equals(ezsigndiscussionResponseCompound.iEzsigndiscussionX)) &&
        (this.iEzsigndiscussionY == null ? ezsigndiscussionResponseCompound.iEzsigndiscussionY == null : this.iEzsigndiscussionY.equals(ezsigndiscussionResponseCompound.iEzsigndiscussionY)) &&
        (this.iEzsigndiscussionPagenumber == null ? ezsigndiscussionResponseCompound.iEzsigndiscussionPagenumber == null : this.iEzsigndiscussionPagenumber.equals(ezsigndiscussionResponseCompound.iEzsigndiscussionPagenumber)) &&
        (this.objDiscussion == null ? ezsigndiscussionResponseCompound.objDiscussion == null : this.objDiscussion.equals(ezsigndiscussionResponseCompound.objDiscussion));
  }
