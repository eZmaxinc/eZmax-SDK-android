...
public class EzsignbulksendResponseV4 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignbulksendID == null ? ezsignbulksendResponseV4.pkiEzsignbulksendID == null : this.pkiEzsignbulksendID.equals(ezsignbulksendResponseV4.pkiEzsignbulksendID)) &&
        (this.fkiEzsignfoldertypeID == null ? ezsignbulksendResponseV4.fkiEzsignfoldertypeID == null : this.fkiEzsignfoldertypeID.equals(ezsignbulksendResponseV4.fkiEzsignfoldertypeID)) &&
        (this.fkiLanguageID == null ? ezsignbulksendResponseV4.fkiLanguageID == null : this.fkiLanguageID.equals(ezsignbulksendResponseV4.fkiLanguageID)) &&
        (this.sLanguageNameX == null ? ezsignbulksendResponseV4.sLanguageNameX == null : this.sLanguageNameX.equals(ezsignbulksendResponseV4.sLanguageNameX)) &&
        (this.eEzsignbulksendEzsignformfieldorder == null ? ezsignbulksendResponseV4.eEzsignbulksendEzsignformfieldorder == null : this.eEzsignbulksendEzsignformfieldorder.equals(ezsignbulksendResponseV4.eEzsignbulksendEzsignformfieldorder)) &&
        (this.eEzsignfoldertypePrivacylevel == null ? ezsignbulksendResponseV4.eEzsignfoldertypePrivacylevel == null : this.eEzsignfoldertypePrivacylevel.equals(ezsignbulksendResponseV4.eEzsignfoldertypePrivacylevel)) &&
        (this.sEzsignfoldertypeNameX == null ? ezsignbulksendResponseV4.sEzsignfoldertypeNameX == null : this.sEzsignfoldertypeNameX.equals(ezsignbulksendResponseV4.sEzsignfoldertypeNameX)) &&
        (this.sEzsignbulksendDescription == null ? ezsignbulksendResponseV4.sEzsignbulksendDescription == null : this.sEzsignbulksendDescription.equals(ezsignbulksendResponseV4.sEzsignbulksendDescription)) &&
        (this.tEzsignbulksendNote == null ? ezsignbulksendResponseV4.tEzsignbulksendNote == null : this.tEzsignbulksendNote.equals(ezsignbulksendResponseV4.tEzsignbulksendNote)) &&
        (this.bEzsignbulksendNeedvalidation == null ? ezsignbulksendResponseV4.bEzsignbulksendNeedvalidation == null : this.bEzsignbulksendNeedvalidation.equals(ezsignbulksendResponseV4.bEzsignbulksendNeedvalidation)) &&
        (this.bEzsignbulksendIsactive == null ? ezsignbulksendResponseV4.bEzsignbulksendIsactive == null : this.bEzsignbulksendIsactive.equals(ezsignbulksendResponseV4.bEzsignbulksendIsactive)) &&
        (this.objAudit == null ? ezsignbulksendResponseV4.objAudit == null : this.objAudit.equals(ezsignbulksendResponseV4.objAudit));
  }
