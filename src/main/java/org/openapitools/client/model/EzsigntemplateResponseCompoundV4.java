...
public class EzsigntemplateResponseCompoundV4 {
  ...
  private List<EzsigntemplatesignerResponseCompoundV3> aObjEzsigntemplatesigner = null;
  ...
  public void setAObjEzsigntemplatesigner(List<EzsigntemplatesignerResponseCompoundV3> aObjEzsigntemplatesigner) {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplateID == null ? ezsigntemplateResponseCompoundV4.pkiEzsigntemplateID == null : this.pkiEzsigntemplateID.equals(ezsigntemplateResponseCompoundV4.pkiEzsigntemplateID)) &&
        (this.fkiEzsigntemplatedocumentID == null ? ezsigntemplateResponseCompoundV4.fkiEzsigntemplatedocumentID == null : this.fkiEzsigntemplatedocumentID.equals(ezsigntemplateResponseCompoundV4.fkiEzsigntemplatedocumentID)) &&
        (this.fkiEzsignfoldertypeID == null ? ezsigntemplateResponseCompoundV4.fkiEzsignfoldertypeID == null : this.fkiEzsignfoldertypeID.equals(ezsigntemplateResponseCompoundV4.fkiEzsignfoldertypeID)) &&
        (this.objEzsignfoldertype == null ? ezsigntemplateResponseCompoundV4.objEzsignfoldertype == null : this.objEzsignfoldertype.equals(ezsigntemplateResponseCompoundV4.objEzsignfoldertype)) &&
        (this.fkiLanguageID == null ? ezsigntemplateResponseCompoundV4.fkiLanguageID == null : this.fkiLanguageID.equals(ezsigntemplateResponseCompoundV4.fkiLanguageID)) &&
        (this.fkiEzdoctemplatedocumentID == null ? ezsigntemplateResponseCompoundV4.fkiEzdoctemplatedocumentID == null : this.fkiEzdoctemplatedocumentID.equals(ezsigntemplateResponseCompoundV4.fkiEzdoctemplatedocumentID)) &&
        (this.sEzdoctemplatedocumentNameX == null ? ezsigntemplateResponseCompoundV4.sEzdoctemplatedocumentNameX == null : this.sEzdoctemplatedocumentNameX.equals(ezsigntemplateResponseCompoundV4.sEzdoctemplatedocumentNameX)) &&
        (this.sLanguageNameX == null ? ezsigntemplateResponseCompoundV4.sLanguageNameX == null : this.sLanguageNameX.equals(ezsigntemplateResponseCompoundV4.sLanguageNameX)) &&
        (this.sEzsigntemplateDescription == null ? ezsigntemplateResponseCompoundV4.sEzsigntemplateDescription == null : this.sEzsigntemplateDescription.equals(ezsigntemplateResponseCompoundV4.sEzsigntemplateDescription)) &&
        (this.sEzsigntemplateExternaldescription == null ? ezsigntemplateResponseCompoundV4.sEzsigntemplateExternaldescription == null : this.sEzsigntemplateExternaldescription.equals(ezsigntemplateResponseCompoundV4.sEzsigntemplateExternaldescription)) &&
        (this.tEzsigntemplateComment == null ? ezsigntemplateResponseCompoundV4.tEzsigntemplateComment == null : this.tEzsigntemplateComment.equals(ezsigntemplateResponseCompoundV4.tEzsigntemplateComment)) &&
        (this.eEzsigntemplateRecognition == null ? ezsigntemplateResponseCompoundV4.eEzsigntemplateRecognition == null : this.eEzsigntemplateRecognition.equals(ezsigntemplateResponseCompoundV4.eEzsigntemplateRecognition)) &&
        (this.sEzsigntemplateFilenameregexp == null ? ezsigntemplateResponseCompoundV4.sEzsigntemplateFilenameregexp == null : this.sEzsigntemplateFilenameregexp.equals(ezsigntemplateResponseCompoundV4.sEzsigntemplateFilenameregexp)) &&
        (this.bEzsigntemplateAdminonly == null ? ezsigntemplateResponseCompoundV4.bEzsigntemplateAdminonly == null : this.bEzsigntemplateAdminonly.equals(ezsigntemplateResponseCompoundV4.bEzsigntemplateAdminonly)) &&
        (this.sEzsignfoldertypeNameX == null ? ezsigntemplateResponseCompoundV4.sEzsignfoldertypeNameX == null : this.sEzsignfoldertypeNameX.equals(ezsigntemplateResponseCompoundV4.sEzsignfoldertypeNameX)) &&
        (this.objAudit == null ? ezsigntemplateResponseCompoundV4.objAudit == null : this.objAudit.equals(ezsigntemplateResponseCompoundV4.objAudit)) &&
        (this.bEzsigntemplateEditallowed == null ? ezsigntemplateResponseCompoundV4.bEzsigntemplateEditallowed == null : this.bEzsigntemplateEditallowed.equals(ezsigntemplateResponseCompoundV4.bEzsigntemplateEditallowed)) &&
        (this.eEzsigntemplateType == null ? ezsigntemplateResponseCompoundV4.eEzsigntemplateType == null : this.eEzsigntemplateType.equals(ezsigntemplateResponseCompoundV4.eEzsigntemplateType)) &&
        (this.objEzsigntemplatedocument == null ? ezsigntemplateResponseCompoundV4.objEzsigntemplatedocument == null : this.objEzsigntemplatedocument.equals(ezsigntemplateResponseCompoundV4.objEzsigntemplatedocument)) &&
        (this.aObjEzsigntemplatesigner == null ? ezsigntemplateResponseCompoundV4.aObjEzsigntemplatesigner == null : this.aObjEzsigntemplatesigner.equals(ezsigntemplateResponseCompoundV4.aObjEzsigntemplatesigner)) &&
        (this.aObjEzsigntemplateannotation == null ? ezsigntemplateResponseCompoundV4.aObjEzsigntemplateannotation == null : this.aObjEzsigntemplateannotation.equals(ezsigntemplateResponseCompoundV4.aObjEzsigntemplateannotation));
  }
