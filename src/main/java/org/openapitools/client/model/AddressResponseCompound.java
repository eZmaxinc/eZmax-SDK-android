...
public class AddressResponseCompound {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiAddressID == null ? addressResponseCompound.pkiAddressID == null : this.pkiAddressID.equals(addressResponseCompound.pkiAddressID)) &&
        (this.fkiAddresstypeID == null ? addressResponseCompound.fkiAddresstypeID == null : this.fkiAddresstypeID.equals(addressResponseCompound.fkiAddresstypeID)) &&
        (this.sAddressCivic == null ? addressResponseCompound.sAddressCivic == null : this.sAddressCivic.equals(addressResponseCompound.sAddressCivic)) &&
        (this.sAddressStreet == null ? addressResponseCompound.sAddressStreet == null : this.sAddressStreet.equals(addressResponseCompound.sAddressStreet)) &&
        (this.sAddressSuite == null ? addressResponseCompound.sAddressSuite == null : this.sAddressSuite.equals(addressResponseCompound.sAddressSuite)) &&
        (this.sAddressCity == null ? addressResponseCompound.sAddressCity == null : this.sAddressCity.equals(addressResponseCompound.sAddressCity)) &&
        (this.fkiProvinceID == null ? addressResponseCompound.fkiProvinceID == null : this.fkiProvinceID.equals(addressResponseCompound.fkiProvinceID)) &&
        (this.sProvinceNameX == null ? addressResponseCompound.sProvinceNameX == null : this.sProvinceNameX.equals(addressResponseCompound.sProvinceNameX)) &&
        (this.fkiCountryID == null ? addressResponseCompound.fkiCountryID == null : this.fkiCountryID.equals(addressResponseCompound.fkiCountryID)) &&
        (this.sCountryNameX == null ? addressResponseCompound.sCountryNameX == null : this.sCountryNameX.equals(addressResponseCompound.sCountryNameX)) &&
        (this.sAddressZip == null ? addressResponseCompound.sAddressZip == null : this.sAddressZip.equals(addressResponseCompound.sAddressZip)) &&
        (this.fAddressLongitude == null ? addressResponseCompound.fAddressLongitude == null : this.fAddressLongitude.equals(addressResponseCompound.fAddressLongitude)) &&
        (this.fAddressLatitude == null ? addressResponseCompound.fAddressLatitude == null : this.fAddressLatitude.equals(addressResponseCompound.fAddressLatitude));
  }
