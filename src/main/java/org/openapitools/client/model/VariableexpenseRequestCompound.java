...
import org.openapitools.client.model.VariableexpenseRequest;
 ...
 **/
@ApiModel(description = "A Variableexpense Object and children")
public class VariableexpenseRequestCompound extends VariableexpenseRequest {
   ...
   * maximum: 255
   **/
  @ApiModelProperty(value = "The unique ID of the Variableexpense")
   ...
   **/
  @ApiModelProperty(required = true, value = "The code of the Variableexpense")
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiVariableexpenseID == null ? variableexpenseRequestCompound.pkiVariableexpenseID == null : this.pkiVariableexpenseID.equals(variableexpenseRequestCompound.pkiVariableexpenseID)) &&
        (this.sVariableexpenseCode == null ? variableexpenseRequestCompound.sVariableexpenseCode == null : this.sVariableexpenseCode.equals(variableexpenseRequestCompound.sVariableexpenseCode)) &&
        (this.objVariableexpenseDescription == null ? variableexpenseRequestCompound.objVariableexpenseDescription == null : this.objVariableexpenseDescription.equals(variableexpenseRequestCompound.objVariableexpenseDescription)) &&
        (this.eVariableexpenseTaxable == null ? variableexpenseRequestCompound.eVariableexpenseTaxable == null : this.eVariableexpenseTaxable.equals(variableexpenseRequestCompound.eVariableexpenseTaxable)) &&
        (this.bVariableexpenseIsactive == null ? variableexpenseRequestCompound.bVariableexpenseIsactive == null : this.bVariableexpenseIsactive.equals(variableexpenseRequestCompound.bVariableexpenseIsactive));
  }
