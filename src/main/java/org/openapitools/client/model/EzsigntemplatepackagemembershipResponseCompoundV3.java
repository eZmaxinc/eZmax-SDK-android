...
public class EzsigntemplatepackagemembershipResponseCompoundV3 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatepackagemembershipID == null ? ezsigntemplatepackagemembershipResponseCompoundV3.pkiEzsigntemplatepackagemembershipID == null : this.pkiEzsigntemplatepackagemembershipID.equals(ezsigntemplatepackagemembershipResponseCompoundV3.pkiEzsigntemplatepackagemembershipID)) &&
        (this.fkiEzsigntemplatepackageID == null ? ezsigntemplatepackagemembershipResponseCompoundV3.fkiEzsigntemplatepackageID == null : this.fkiEzsigntemplatepackageID.equals(ezsigntemplatepackagemembershipResponseCompoundV3.fkiEzsigntemplatepackageID)) &&
        (this.fkiEzsigntemplateID == null ? ezsigntemplatepackagemembershipResponseCompoundV3.fkiEzsigntemplateID == null : this.fkiEzsigntemplateID.equals(ezsigntemplatepackagemembershipResponseCompoundV3.fkiEzsigntemplateID)) &&
        (this.iEzsigntemplatepackagemembershipOrder == null ? ezsigntemplatepackagemembershipResponseCompoundV3.iEzsigntemplatepackagemembershipOrder == null : this.iEzsigntemplatepackagemembershipOrder.equals(ezsigntemplatepackagemembershipResponseCompoundV3.iEzsigntemplatepackagemembershipOrder)) &&
        (this.objEzsigntemplate == null ? ezsigntemplatepackagemembershipResponseCompoundV3.objEzsigntemplate == null : this.objEzsigntemplate.equals(ezsigntemplatepackagemembershipResponseCompoundV3.objEzsigntemplate)) &&
        (this.aObjEzsigntemplatepackagesignermembership == null ? ezsigntemplatepackagemembershipResponseCompoundV3.aObjEzsigntemplatepackagesignermembership == null : this.aObjEzsigntemplatepackagesignermembership.equals(ezsigntemplatepackagemembershipResponseCompoundV3.aObjEzsigntemplatepackagesignermembership));
  }
