...
public class EzsigntemplatepackagesignerRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatepackagesignerID == null ? ezsigntemplatepackagesignerRequest.pkiEzsigntemplatepackagesignerID == null : this.pkiEzsigntemplatepackagesignerID.equals(ezsigntemplatepackagesignerRequest.pkiEzsigntemplatepackagesignerID)) &&
        ...
        (this.fkiEzdoctemplatedocumentID == null ? ezsigntemplatepackagesignerRequest.fkiEzdoctemplatedocumentID == null : this.fkiEzdoctemplatedocumentID.equals(ezsigntemplatepackagesignerRequest.fkiEzdoctemplatedocumentID)) &&
        (this.fkiUserID == null ? ezsigntemplatepackagesignerRequest.fkiUserID == null : this.fkiUserID.equals(ezsigntemplatepackagesignerRequest.fkiUserID)) &&
        (this.fkiUsergroupID == null ? ezsigntemplatepackagesignerRequest.fkiUsergroupID == null : this.fkiUsergroupID.equals(ezsigntemplatepackagesignerRequest.fkiUsergroupID)) &&
        (this.bEzsigntemplatepackagesignerReceivecopy == null ? ezsigntemplatepackagesignerRequest.bEzsigntemplatepackagesignerReceivecopy == null : this.bEzsigntemplatepackagesignerReceivecopy.equals(ezsigntemplatepackagesignerRequest.bEzsigntemplatepackagesignerReceivecopy)) &&
        (this.eEzsigntemplatepackagesignerMapping == null ? ezsigntemplatepackagesignerRequest.eEzsigntemplatepackagesignerMapping == null : this.eEzsigntemplatepackagesignerMapping.equals(ezsigntemplatepackagesignerRequest.eEzsigntemplatepackagesignerMapping)) &&
