...
public class EzsigntemplatepackagesignerResponseCompoundV3 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatepackagesignerID == null ? ezsigntemplatepackagesignerResponseCompoundV3.pkiEzsigntemplatepackagesignerID == null : this.pkiEzsigntemplatepackagesignerID.equals(ezsigntemplatepackagesignerResponseCompoundV3.pkiEzsigntemplatepackagesignerID)) &&
        (this.fkiEzsigntemplatepackageID == null ? ezsigntemplatepackagesignerResponseCompoundV3.fkiEzsigntemplatepackageID == null : this.fkiEzsigntemplatepackageID.equals(ezsigntemplatepackagesignerResponseCompoundV3.fkiEzsigntemplatepackageID)) &&
        (this.fkiEzdoctemplatedocumentID == null ? ezsigntemplatepackagesignerResponseCompoundV3.fkiEzdoctemplatedocumentID == null : this.fkiEzdoctemplatedocumentID.equals(ezsigntemplatepackagesignerResponseCompoundV3.fkiEzdoctemplatedocumentID)) &&
        (this.fkiUserID == null ? ezsigntemplatepackagesignerResponseCompoundV3.fkiUserID == null : this.fkiUserID.equals(ezsigntemplatepackagesignerResponseCompoundV3.fkiUserID)) &&
        (this.fkiUsergroupID == null ? ezsigntemplatepackagesignerResponseCompoundV3.fkiUsergroupID == null : this.fkiUsergroupID.equals(ezsigntemplatepackagesignerResponseCompoundV3.fkiUsergroupID)) &&
        (this.sEzdoctemplatedocumentNameX == null ? ezsigntemplatepackagesignerResponseCompoundV3.sEzdoctemplatedocumentNameX == null : this.sEzdoctemplatedocumentNameX.equals(ezsigntemplatepackagesignerResponseCompoundV3.sEzdoctemplatedocumentNameX)) &&
        (this.eEzsigntemplatepackagesignerRole == null ? ezsigntemplatepackagesignerResponseCompoundV3.eEzsigntemplatepackagesignerRole == null : this.eEzsigntemplatepackagesignerRole.equals(ezsigntemplatepackagesignerResponseCompoundV3.eEzsigntemplatepackagesignerRole)) &&
        (this.eEzsigntemplatepackagesignerMapping == null ? ezsigntemplatepackagesignerResponseCompoundV3.eEzsigntemplatepackagesignerMapping == null : this.eEzsigntemplatepackagesignerMapping.equals(ezsigntemplatepackagesignerResponseCompoundV3.eEzsigntemplatepackagesignerMapping)) &&
        (this.sEzsigntemplatepackagesignerDescription == null ? ezsigntemplatepackagesignerResponseCompoundV3.sEzsigntemplatepackagesignerDescription == null : this.sEzsigntemplatepackagesignerDescription.equals(ezsigntemplatepackagesignerResponseCompoundV3.sEzsigntemplatepackagesignerDescription)) &&
        (this.sUserName == null ? ezsigntemplatepackagesignerResponseCompoundV3.sUserName == null : this.sUserName.equals(ezsigntemplatepackagesignerResponseCompoundV3.sUserName)) &&
        (this.sUsergroupNameX == null ? ezsigntemplatepackagesignerResponseCompoundV3.sUsergroupNameX == null : this.sUsergroupNameX.equals(ezsigntemplatepackagesignerResponseCompoundV3.sUsergroupNameX));
  }
