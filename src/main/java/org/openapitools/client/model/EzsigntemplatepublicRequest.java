...
public class EzsigntemplatepublicRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatepublicID == null ? ezsigntemplatepublicRequest.pkiEzsigntemplatepublicID == null : this.pkiEzsigntemplatepublicID.equals(ezsigntemplatepublicRequest.pkiEzsigntemplatepublicID)) &&
        (this.fkiEzsignfoldertypeID == null ? ezsigntemplatepublicRequest.fkiEzsignfoldertypeID == null : this.fkiEzsignfoldertypeID.equals(ezsigntemplatepublicRequest.fkiEzsignfoldertypeID)) &&
        (this.fkiUserlogintypeID == null ? ezsigntemplatepublicRequest.fkiUserlogintypeID == null : this.fkiUserlogintypeID.equals(ezsigntemplatepublicRequest.fkiUserlogintypeID)) &&
        (this.fkiEzsigntemplateID == null ? ezsigntemplatepublicRequest.fkiEzsigntemplateID == null : this.fkiEzsigntemplateID.equals(ezsigntemplatepublicRequest.fkiEzsigntemplateID)) &&
        (this.fkiEzsigntemplatepackageID == null ? ezsigntemplatepublicRequest.fkiEzsigntemplatepackageID == null : this.fkiEzsigntemplatepackageID.equals(ezsigntemplatepublicRequest.fkiEzsigntemplatepackageID)) &&
        (this.sEzsigntemplatepublicDescription == null ? ezsigntemplatepublicRequest.sEzsigntemplatepublicDescription == null : this.sEzsigntemplatepublicDescription.equals(ezsigntemplatepublicRequest.sEzsigntemplatepublicDescription)) &&
        (this.bEzsigntemplatepublicIsactive == null ? ezsigntemplatepublicRequest.bEzsigntemplatepublicIsactive == null : this.bEzsigntemplatepublicIsactive.equals(ezsigntemplatepublicRequest.bEzsigntemplatepublicIsactive)) &&
        (this.tEzsigntemplatepublicNote == null ? ezsigntemplatepublicRequest.tEzsigntemplatepublicNote == null : this.tEzsigntemplatepublicNote.equals(ezsigntemplatepublicRequest.tEzsigntemplatepublicNote)) &&
        (this.eEzsigntemplatepublicLimittype == null ? ezsigntemplatepublicRequest.eEzsigntemplatepublicLimittype == null : this.eEzsigntemplatepublicLimittype.equals(ezsigntemplatepublicRequest.eEzsigntemplatepublicLimittype)) &&
        (this.iEzsigntemplatepublicLimit == null ? ezsigntemplatepublicRequest.iEzsigntemplatepublicLimit == null : this.iEzsigntemplatepublicLimit.equals(ezsigntemplatepublicRequest.iEzsigntemplatepublicLimit));
  }
