...
public class EzsigntemplatedocumentpagerecognitionRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsigntemplatedocumentpagerecognitionID == null ? ezsigntemplatedocumentpagerecognitionRequest.pkiEzsigntemplatedocumentpagerecognitionID == null : this.pkiEzsigntemplatedocumentpagerecognitionID.equals(ezsigntemplatedocumentpagerecognitionRequest.pkiEzsigntemplatedocumentpagerecognitionID)) &&
        (this.fkiEzsigntemplatedocumentpageID == null ? ezsigntemplatedocumentpagerecognitionRequest.fkiEzsigntemplatedocumentpageID == null : this.fkiEzsigntemplatedocumentpageID.equals(ezsigntemplatedocumentpagerecognitionRequest.fkiEzsigntemplatedocumentpageID)) &&
        (this.eEzsigntemplatedocumentpagerecognitionOperator == null ? ezsigntemplatedocumentpagerecognitionRequest.eEzsigntemplatedocumentpagerecognitionOperator == null : this.eEzsigntemplatedocumentpagerecognitionOperator.equals(ezsigntemplatedocumentpagerecognitionRequest.eEzsigntemplatedocumentpagerecognitionOperator)) &&
        (this.eEzsigntemplatedocumentpagerecognitionSection == null ? ezsigntemplatedocumentpagerecognitionRequest.eEzsigntemplatedocumentpagerecognitionSection == null : this.eEzsigntemplatedocumentpagerecognitionSection.equals(ezsigntemplatedocumentpagerecognitionRequest.eEzsigntemplatedocumentpagerecognitionSection)) &&
        (this.iEzsigntemplatedocumentpagerecognitionSimilarpercentage == null ? ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionSimilarpercentage == null : this.iEzsigntemplatedocumentpagerecognitionSimilarpercentage.equals(ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionSimilarpercentage)) &&
        (this.iEzsigntemplatedocumentpagerecognitionX == null ? ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionX == null : this.iEzsigntemplatedocumentpagerecognitionX.equals(ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionX)) &&
        (this.iEzsigntemplatedocumentpagerecognitionY == null ? ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionY == null : this.iEzsigntemplatedocumentpagerecognitionY.equals(ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionY)) &&
        (this.iEzsigntemplatedocumentpagerecognitionWidth == null ? ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionWidth == null : this.iEzsigntemplatedocumentpagerecognitionWidth.equals(ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionWidth)) &&
        (this.iEzsigntemplatedocumentpagerecognitionHeight == null ? ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionHeight == null : this.iEzsigntemplatedocumentpagerecognitionHeight.equals(ezsigntemplatedocumentpagerecognitionRequest.iEzsigntemplatedocumentpagerecognitionHeight)) &&
        (this.tEzsigntemplatedocumentpagerecognitionText == null ? ezsigntemplatedocumentpagerecognitionRequest.tEzsigntemplatedocumentpagerecognitionText == null : this.tEzsigntemplatedocumentpagerecognitionText.equals(ezsigntemplatedocumentpagerecognitionRequest.tEzsigntemplatedocumentpagerecognitionText));
  }
