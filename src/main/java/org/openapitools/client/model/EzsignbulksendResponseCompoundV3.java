...
public class EzsignbulksendResponseCompoundV3 {
  ...
  public boolean equals(Object o) {
    ...
    return (this.pkiEzsignbulksendID == null ? ezsignbulksendResponseCompoundV3.pkiEzsignbulksendID == null : this.pkiEzsignbulksendID.equals(ezsignbulksendResponseCompoundV3.pkiEzsignbulksendID)) &&
        (this.fkiEzsignfoldertypeID == null ? ezsignbulksendResponseCompoundV3.fkiEzsignfoldertypeID == null : this.fkiEzsignfoldertypeID.equals(ezsignbulksendResponseCompoundV3.fkiEzsignfoldertypeID)) &&
        (this.fkiLanguageID == null ? ezsignbulksendResponseCompoundV3.fkiLanguageID == null : this.fkiLanguageID.equals(ezsignbulksendResponseCompoundV3.fkiLanguageID)) &&
        (this.sLanguageNameX == null ? ezsignbulksendResponseCompoundV3.sLanguageNameX == null : this.sLanguageNameX.equals(ezsignbulksendResponseCompoundV3.sLanguageNameX)) &&
        (this.eEzsignbulksendEzsignformfieldorder == null ? ezsignbulksendResponseCompoundV3.eEzsignbulksendEzsignformfieldorder == null : this.eEzsignbulksendEzsignformfieldorder.equals(ezsignbulksendResponseCompoundV3.eEzsignbulksendEzsignformfieldorder)) &&
        (this.eEzsignfoldertypePrivacylevel == null ? ezsignbulksendResponseCompoundV3.eEzsignfoldertypePrivacylevel == null : this.eEzsignfoldertypePrivacylevel.equals(ezsignbulksendResponseCompoundV3.eEzsignfoldertypePrivacylevel)) &&
        (this.sEzsignfoldertypeNameX == null ? ezsignbulksendResponseCompoundV3.sEzsignfoldertypeNameX == null : this.sEzsignfoldertypeNameX.equals(ezsignbulksendResponseCompoundV3.sEzsignfoldertypeNameX)) &&
        (this.sEzsignbulksendDescription == null ? ezsignbulksendResponseCompoundV3.sEzsignbulksendDescription == null : this.sEzsignbulksendDescription.equals(ezsignbulksendResponseCompoundV3.sEzsignbulksendDescription)) &&
        (this.tEzsignbulksendNote == null ? ezsignbulksendResponseCompoundV3.tEzsignbulksendNote == null : this.tEzsignbulksendNote.equals(ezsignbulksendResponseCompoundV3.tEzsignbulksendNote)) &&
        (this.bEzsignbulksendNeedvalidation == null ? ezsignbulksendResponseCompoundV3.bEzsignbulksendNeedvalidation == null : this.bEzsignbulksendNeedvalidation.equals(ezsignbulksendResponseCompoundV3.bEzsignbulksendNeedvalidation)) &&
        (this.bEzsignbulksendIsactive == null ? ezsignbulksendResponseCompoundV3.bEzsignbulksendIsactive == null : this.bEzsignbulksendIsactive.equals(ezsignbulksendResponseCompoundV3.bEzsignbulksendIsactive)) &&
        (this.objAudit == null ? ezsignbulksendResponseCompoundV3.objAudit == null : this.objAudit.equals(ezsignbulksendResponseCompoundV3.objAudit)) &&
        (this.aObjEzsignbulksenddocumentmapping == null ? ezsignbulksendResponseCompoundV3.aObjEzsignbulksenddocumentmapping == null : this.aObjEzsignbulksenddocumentmapping.equals(ezsignbulksendResponseCompoundV3.aObjEzsignbulksenddocumentmapping)) &&
        (this.aObjEzsignbulksendsignermapping == null ? ezsignbulksendResponseCompoundV3.aObjEzsignbulksendsignermapping == null : this.aObjEzsignbulksendsignermapping.equals(ezsignbulksendResponseCompoundV3.aObjEzsignbulksendsignermapping));
  }
