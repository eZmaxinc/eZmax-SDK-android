...
public class TextstylestaticRequest {
  ...
  public boolean equals(Object o) {
    ...
    return (this.fkiFontID == null ? textstylestaticRequest.fkiFontID == null : this.fkiFontID.equals(textstylestaticRequest.fkiFontID)) &&
        (this.bTextstylestaticBold == null ? textstylestaticRequest.bTextstylestaticBold == null : this.bTextstylestaticBold.equals(textstylestaticRequest.bTextstylestaticBold)) &&
        (this.bTextstylestaticUnderline == null ? textstylestaticRequest.bTextstylestaticUnderline == null : this.bTextstylestaticUnderline.equals(textstylestaticRequest.bTextstylestaticUnderline)) &&
        (this.bTextstylestaticItalic == null ? textstylestaticRequest.bTextstylestaticItalic == null : this.bTextstylestaticItalic.equals(textstylestaticRequest.bTextstylestaticItalic)) &&
        (this.bTextstylestaticStrikethrough == null ? textstylestaticRequest.bTextstylestaticStrikethrough == null : this.bTextstylestaticStrikethrough.equals(textstylestaticRequest.bTextstylestaticStrikethrough)) &&
        (this.iTextstylestaticFontcolor == null ? textstylestaticRequest.iTextstylestaticFontcolor == null : this.iTextstylestaticFontcolor.equals(textstylestaticRequest.iTextstylestaticFontcolor)) &&
        (this.iTextstylestaticSize == null ? textstylestaticRequest.iTextstylestaticSize == null : this.iTextstylestaticSize.equals(textstylestaticRequest.iTextstylestaticSize));
  }
