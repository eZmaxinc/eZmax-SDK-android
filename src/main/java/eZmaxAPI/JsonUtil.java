...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("WordPositionResponse".equalsIgnoreCase(className)) {
      return new TypeToken<List<WordPositionResponse>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("WordPositionResponse".equalsIgnoreCase(className)) {
      return new TypeToken<WordPositionResponse>(){}.getType();
    }
